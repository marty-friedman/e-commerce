...
angular.module('restrictionsManagementApp', ['templateCacheDecoratorModule', 'itemManagementModule', 'restrictionsServiceModule'])

    .controller('testController', function($timeout, restrictionsService) {
