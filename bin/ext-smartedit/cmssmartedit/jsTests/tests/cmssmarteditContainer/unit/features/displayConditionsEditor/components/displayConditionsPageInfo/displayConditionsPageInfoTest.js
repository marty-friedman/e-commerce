...
describe('displayConditionsPageInfo', function() {
    ...
    describe('for a primary page', function() {
        ...
        xit('should render the primary page translated description', function() {
            expect(element).toContainElementText('This is a primary page and it will be displayed if no other variation page exists');
        });
    });
    ...
    describe('for a page variation', function() {
        ...
        xit('should render the variation page translated description', function() {
            expect(element).toContainElementText('This is a variation page that supports restriction rules to control the page visibility');
        });
    });
});
