...
describe('seCatalogInformationService', function() {
    ...
    beforeEach(module('yLoDashModule'));
    ...
    beforeEach(inject(function(_$rootScope_, $q) {
        ...
        // Products
        mocks.productService.getProducts.and.returnResolvedPromise(products);
    ...
    it('WHEN productsFetchStrategy is called ' +
        ...
        function() {
            ...
            promise.then(function(result) {
                expect(mocks.productService.getProducts).toHaveBeenCalledWith(catalogInfo, mask, pageSize, currentPage);
    ...
    it('WHEN categoriesFetchStrategy is called ' +
        ...
        function() {
            ...
            // THEN 
            promise.then(function(result) {
                expect(mocks.productCategoryService.getProductById).toHaveBeenCalledWith(SITE_1_UID, categoryId);
                expect(result).toEqual({
                    uid: 'some category',
                    id: 'some category'
                });
