...
describe('displayConditionsPageVariations', function() {
    ...
    describe('with some variations', function() {
        ...
        xit('should display a variations description', function() {
            expect(element).toContainElementText('The variation page with the most applicable restrictions is displayed. If more than one variation page applies, the oldest variation page is displayed');
        });
    });
});
