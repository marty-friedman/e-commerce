...
module.exports = (function() {
    ...
    componentObject.elements = {
        ...
        getSubTypeSelector: function(fieldQualifier) {
            return this.getDropdownByQualifier(fieldQualifier).element(by.css('sub-type-selector '));
        },
        getSubTypeSelectorDropdownButton: function(fieldQualifier) {
            return this.getSubTypeSelector(fieldQualifier).element(by.css('.select2-arrow'));
        },
        getSubTypeSelectorOption: function(fieldQualifier, componentType) {
            return this.getSubTypeSelector(fieldQualifier).element(by.cssContainingText('#ui-select-choices-2 li span', componentType));
        },
    ...
    componentObject.actions = {
        ...
        openSubTypeSelector: function(fieldQualifier) {
            return browser.click(componentObject.elements.getSubTypeSelectorDropdownButton(fieldQualifier));
        },
        selectComponentType: function(fieldQualifier, componentType) {
            return this.openSubTypeSelector(fieldQualifier).then(function() {
                return browser.click(componentObject.elements.getSubTypeSelectorOption(fieldQualifier, componentType));
            });
        },
        openNewNestedComponentOfTypeFromDropdown: function(fieldQualifier, newComponentName, componentType) {
            ...
            return this.searchComponentInDropdown(fieldQualifier, selectType, newComponentName).then(function() {
                return this.clickCreateNewComponentButton(fieldQualifier).then(function() {
                    return this.selectComponentType(fieldQualifier, componentType);
                }.bind(this));
            }.bind(this));
        },
