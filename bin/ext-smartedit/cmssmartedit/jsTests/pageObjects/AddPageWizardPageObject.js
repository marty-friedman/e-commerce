...
module.exports = (function() {
    ...
    pageObject.elements = {
        ...
        getPage1PrimaryPageOption: function() {
            return by.xpath("//label[contains(., 'Primary page associated to the variation')]/following-sibling::div//span[contains(., 'page1TitleSuffix')]");
        },
        ...
        getProductPage1PrimaryPageOption: function() {
            return by.xpath("//div[@id='page-condition-primary-selector-id']//span[contains(., 'productPage1')]");
        },
    ...
    pageObject.actions = {
        ...
        selectPage1AsPrimaryPage: function() {
            return browser.click(displayCondition.elements.getConditionDropdownToggle()).then((function() {
