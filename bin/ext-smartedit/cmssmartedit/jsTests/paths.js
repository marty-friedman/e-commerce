...
module.exports = function() {
    ...
    paths.tests.cmssmarteditTSUnitTestFiles = paths.tests.cmssmarteditUnitTestsRoot + '/features/**/*.ts';
    paths.tests.cmssmarteditContainerUnitTestFiles = paths.tests.cmssmarteditContainerUnitTestsRoot + '/features/**/*.js';
    paths.tests.cmssmarteditContainerTSUnitTestFiles = paths.tests.cmssmarteditContainerUnitTestsRoot + '/features/**/*.ts';
    ...
    paths.target.featureExtensionsSmartEditImport = paths.target.features + '/cmssmartedit/index.ts';
    paths.target.featureExtensionsSmartEditContainerImport = paths.target.features + '/cmssmarteditContainer/index.ts';
    ...
    paths.cmssmarteditKarmaConfFiles = lodash.concat(
        ...
        paths.target.commonsTSFiles,
        paths.target.cmssmarteditFiles,
        paths.target.cmssmarteditTSFiles,
        paths.tests.cmssmarteditUnitTestFiles,
        paths.tests.cmssmarteditTSUnitTestFiles, {
    ...
    paths.cmssmarteditContainerKarmaConfFiles = lodash.concat(
        ...
        paths.target.cmssmarteditContainerTSFiles,
        paths.target.commonsFiles,
        paths.target.commonsTSFiles,
        paths.tests.cmssmarteditContainerUnitTestFiles,
        paths.tests.cmssmarteditContainerTSUnitTestFiles, {
