 ...
 */
angular.module('cmsItemDropdownDropdownPopulatorModule', ['uriDropdownPopulatorModule', 'genericEditorStackServiceModule'])
    .factory('CMSItemDropdownDropdownPopulator', function(extend, UriDropdownPopulatorFactory, genericEditorStackService) {
        ...
        CmsItemDropdownDropdownPopulator = extend(UriDropdownPopulatorFactory, CmsItemDropdownDropdownPopulator);

        CmsItemDropdownDropdownPopulator.prototype.fetchAll = function(payload) {
            preparePayload(payload);
            return UriDropdownPopulatorFactory.prototype.fetchAll(payload).then(function(items) {
        ...
        CmsItemDropdownDropdownPopulator.prototype.fetchPage = function(payload) {
            preparePayload(payload);
            return UriDropdownPopulatorFactory.prototype.fetchPage(payload).then(function(result) {
        ...
        CmsItemDropdownDropdownPopulator.prototype.getItem = function(payload) {
            preparePayload(payload);
            return UriDropdownPopulatorFactory.prototype.getItem(payload);
        };
