...
angular.module('synchronizationPanelModule', [
    ...
    .controller('SynchronizationPanelController', function($attrs, $translate, isBlank, SYNCHRONIZATION_POLLING, SYNCHRONIZATION_STATUSES, alertService, systemEventService, timerService, crossFrameEventService, catalogService, l10nFilter, sharedDataService, waitDialogService) {
