...
(function() {
     ...
     */
    angular.module('resourceModule', ['smarteditServicesModule', 'resourceLocationsModule', 'functionsModule'])
        /**
         * @ngdoc service
        ...
        .factory('navigationNodeEntriesResource', function(restServiceFactory, NAVIGATION_MANAGEMENT_ENTRIES_RESOURCE_URI) {
        ...
        .factory('pageInfoRestService', function(restServiceFactory, PAGEINFO_RESOURCE_URI) {
        ...
        .factory('navigationEntriesRestService', function(restServiceFactory, NAVIGATION_MANAGEMENT_ENTRIES_RESOURCE_URI) {
            return restServiceFactory.get(NAVIGATION_MANAGEMENT_ENTRIES_RESOURCE_URI);
        })
        .factory('navigationEntryTypesRestService', function(restServiceFactory, NAVIGATION_MANAGEMENT_ENTRY_TYPES_RESOURCE_URI) {
