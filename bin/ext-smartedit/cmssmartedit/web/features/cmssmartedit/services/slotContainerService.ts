...
export class SlotContainerService {
	...
	// Constructor
	// --------------------------------------------------------------------------------------
	constructor(private $q: angular.IQService, private lodash: any, restServiceFactory: IRestServiceFactory, private experienceService: any, PAGE_CONTEXT_SITE_ID: string, PAGE_CONTEXT_CATALOG: string, PAGE_CONTEXT_CATALOG_VERSION: string) {
