 ...
 *
 */
angular.module('slotRestrictionsServiceModule', ['yLoDashModule', 'gatewayProxyModule', 'crossFrameEventServiceModule', 'componentHandlerServiceModule', 'slotSharedServiceModule', 'smarteditServicesModule', 'functionsModule', 'cmsSmarteditServicesModule'])
    /**
     * @ngdoc service
     ...
     * whether a component of a certain type is allowed or forbidden in a particular slot.
     */
    .service('slotRestrictionsService', function($q, $log, lodash, isBlank, gatewayProxy, crossFrameEventService, EVENTS, componentHandlerService, slotSharedService, restServiceFactory, pageContentSlotsComponentsRestService, CONTENT_SLOT_TYPE_RESTRICTION_RESOURCE_URI, CONTENT_SLOT_TYPE) {
