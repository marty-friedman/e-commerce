...
(function() {
     ...
     *
     */
    angular.module('cmsDragAndDropServiceModule', ['yjqueryModule', 'dragAndDropServiceModule', 'alertServiceModule', 'yLoDashModule', 'componentHandlerServiceModule', 'eventServiceModule', 'gatewayFactoryModule', 'slotRestrictionsServiceModule', 'componentEditingFacadeModule', 'translationServiceModule', 'removeComponentServiceModule',
            'smarteditServicesModule', 'cmsSmarteditServicesModule', 'browserServiceModule', 'seConstantsModule'
        ])
        /**
         * @ngdoc object
        ...
        .service('cmsDragAndDropService', function($q, $window, $translate, $timeout, yjQuery, lodash, dragAndDropService, componentHandlerService, systemEventService, gatewayFactory, slotRestrictionsService, alertService, assetsService, browserService, componentEditingFacade, waitDialogService, DRAG_AND_DROP_EVENTS, COMPONENT_REMOVED_EVENT, CONTENT_SLOT_TYPE, OVERLAY_RERENDERED_EVENT, CONTRACT_CHANGE_LISTENER_PROCESS_EVENTS, SMARTEDIT_COMPONENT_PROCESS_STATUS, CONTRACT_CHANGE_LISTENER_COMPONENT_PROCESS_STATUS) {
            ...
            this.onStop = function(event) {
                ...
                systemEventService.sendSynchEvent(CONTRACT_CHANGE_LISTENER_PROCESS_EVENTS.RESTART_PROCESS);
            }.bind(this);
                        ...
                        slotRestrictionsService.isSlotEditable(slotId).then(function(slotIsEditable) {
                            ...
                            if (this._highlightedSlot && this._highlightedSlot.id === slotId) {
                                ...
                                if (event.type === "dragenter" && (!oldSlotId || oldSlotId !== slotId)) {
                                    if (this._highlightedSlot && this._highlightedSlot.id === slotId) {
                                        systemEventService.sendSynchEvent(slotId + '_SHOW_SLOT_MENU', slotId);
                                        systemEventService.sendSynchEvent(DRAG_AND_DROP_EVENTS.DRAG_OVER, slotId); // can be used to perform any actions on encountering a drag over event.
                                    }
                                }
                            }
                        }.bind(this));
            ...
            this._clearHighlightedSlot = function() {
                ...
                if (this._highlightedSlot) {
                    ...
                    systemEventService.sendSynchEvent('HIDE_SLOT_MENU');
                    systemEventService.sendSynchEvent(DRAG_AND_DROP_EVENTS.DRAG_LEAVE); // can be used to perform any actions on encountering a drag leave event.
                }
