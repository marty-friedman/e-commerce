...
import org.merchandise.constants.MerchandisecommerceservicesConstants;



/**
 * This is the extension manager of the Merchandisecommerceservices extension.
 */
public class MerchandisecommerceservicesManager extends GeneratedMerchandisecommerceservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MerchandisecommerceservicesManager.class);
	 ...
	 */
	public static MerchandisecommerceservicesManager getInstance()
	{
		return (MerchandisecommerceservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MerchandisecommerceservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MerchandisecommerceservicesManager() // NOPMD 
	{
		LOG.debug("constructor of MerchandisecommerceservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MerchandisecommerceservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MerchandisecommerceservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
