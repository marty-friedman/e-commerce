 ...
 */
package org.merchandise.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(MerchandiseFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MerchandiseFulfilmentProcessConstants.PARENT_PROCESS);
