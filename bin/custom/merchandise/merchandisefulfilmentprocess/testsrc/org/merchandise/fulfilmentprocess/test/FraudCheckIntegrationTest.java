 ...
 */
package org.merchandise.fulfilmentprocess.test;
...
import org.merchandise.fulfilmentprocess.constants.MerchandiseFulfilmentProcessConstants;
import org.merchandise.fulfilmentprocess.test.events.TestEventListenerCountingEvents;
...
public class FraudCheckIntegrationTest extends ServicelayerTest
{
	...
	/**
	 * Load bean definition from merchandisefulfilmentprocess-spring-test-fraudcheck.xml
	 */
	@BeforeClass
	...
	protected static final String PARAM_NAME_MIN_PERIOD_WAITING_FOR_CLEANUP_IN_SECONDS = "merchandisefulfilmentprocess.fraud.minPeriodWaitingForCleanUpInSeconds";
	protected static final String PARAM_NAME_FRAUD_SCORE_LIMIT = "merchandisefulfilmentprocess.fraud.scoreLimit";
	protected static final String PARAM_NAME_FRAUD_SCORE_TOLERANCE = "merchandisefulfilmentprocess.fraud.scoreTolerance";
	...
	public void before() throws Exception
	{
		...
		{
			importCsv("/merchandisefulfilmentprocess/test/testTicketEssentialData.csv", "utf-8");
		}
		importCsv("/merchandisefulfilmentprocess/test/testWarehouses.csv", "utf-8");
	...
	{
		final String processDefinitionName = MerchandiseFulfilmentProcessConstants.ORDER_PROCESS_NAME;
	...
	protected String submitOrderMock(final OrderModel order)
	{
		final OrderProcessModel businessProcessModel = (OrderProcessModel) businessProcessService.createProcess(
				MerchandiseFulfilmentProcessConstants.ORDER_PROCESS_NAME + order.getCode() + +System.currentTimeMillis(),
				MerchandiseFulfilmentProcessConstants.ORDER_PROCESS_NAME);
