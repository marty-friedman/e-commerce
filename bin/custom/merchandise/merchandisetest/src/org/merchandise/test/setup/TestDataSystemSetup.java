 ...
 */
package org.merchandise.test.setup;
...
import org.merchandise.test.constants.MerchandiseTestConstants;
import org.merchandise.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MerchandiseTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/merchandisetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/merchandisetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/merchandisetest/import/cstickets.impex");
			...
			importImpexFile(context, "/merchandisetest/import/csquotes.impex");
		}
	}
}
