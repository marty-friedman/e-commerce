 ...
 */
package org.merchandise.addons.randomimageaddon.jalo;
...
import org.merchandise.addons.randomimageaddon.constants.RandomimageaddonConstants;



/**
 * This is the extension manager of the Randomimageaddon extension.
 */
public class RandomimageaddonManager extends GeneratedRandomimageaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(RandomimageaddonManager.class.getName());
	 ...
	 */
	public static RandomimageaddonManager getInstance()
	{
		return (RandomimageaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				RandomimageaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RandomimageaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of RandomimageaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of RandomimageaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of RandomimageaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
