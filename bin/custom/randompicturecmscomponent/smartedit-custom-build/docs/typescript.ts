...
<em>randompicturecmscomponent/web/features/randompicturecmscomponentContainer/randompicturecmscomponentcontainer.ts</em>
```ts
import {IFeatureService} from 'smarteditcommons';
angular.module('randompicturecmscomponentContainer', ['smarteditServicesModule'])
...
SmartEdit uses Webpack, a module bundler, to bundle the application. The TypeScript source code is transpiled into JavaScript and the existing JavaScript code (ES5) is bundled as is. The following files are the Webpack configuration for the randompicturecmscomponent:
- <em>randompicturecmscomponent/smartedit-custom-build/generated/webpack.[dev/prod/karma].smartedit.config.js</em>
- <em>randompicturecmscomponent/smartedit-custom-build/generated/webpack.[dev/prod/karma].smarteditContainer.config</em>

The 'randompicturecmscomponent' layer of randompicturecmscomponent is a bundle of randompicturecmscomponent and randompicturecmscomponentcommons.
The 'randompicturecmscomponentContainer' layer of randompicturecmscomponent is a bundle of randompicturecmscomponentContainer and randompicturecmscomponentcommons.
