 ...
 */
package org.merchandise.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, MerchandiseFulfilmentProcessConstants.PARENT_PROCESS);
