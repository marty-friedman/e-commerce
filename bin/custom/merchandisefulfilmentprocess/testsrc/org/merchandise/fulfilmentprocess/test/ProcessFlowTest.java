...
import org.merchandise.fulfilmentprocess.test.actions.TestActionTemp;
...
public class ProcessFlowTest extends HybrisJUnit4Test
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/merchandisefulfilmentprocess/test/merchandisefulfilmentprocess-spring-test.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/merchandisefulfilmentprocess/test/process/order-process-spring.xml"));
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/merchandisefulfilmentprocess/test/process/consignment-process-spring.xml"));
		...
		definitonFactory.add("classpath:/merchandisefulfilmentprocess/test/process/order-process.xml");
		definitonFactory.add("classpath:/merchandisefulfilmentprocess/test/process/consignment-process.xml");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/merchandisefulfilmentprocess/test/merchandisefulfilmentprocess-spring-testcleanup.xml"));
