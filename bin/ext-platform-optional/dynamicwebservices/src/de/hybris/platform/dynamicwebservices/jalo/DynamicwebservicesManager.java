 ...
 */
package de.hybris.platform.dynamicwebservices.jalo;
...
import de.hybris.platform.dynamicwebservices.constants.DynamicwebservicesConstants;



/**
 * This is the extension manager of the Dynamicwebservices extension.
 */
public class DynamicwebservicesManager extends GeneratedDynamicwebservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(DynamicwebservicesManager.class.getName());
	 ...
	 */
	public static DynamicwebservicesManager getInstance()
	{
		return (DynamicwebservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				DynamicwebservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DynamicwebservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of DynamicwebservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of DynamicwebservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of DynamicwebservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
