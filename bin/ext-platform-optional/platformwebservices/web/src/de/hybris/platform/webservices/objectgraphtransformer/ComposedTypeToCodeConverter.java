...
public class ComposedTypeToCodeConverter implements PropertyInterceptor<ComposedTypeDTO, String>
{
	@Override
	public String intercept(final PropertyContext ctx, final ComposedTypeDTO source)
	{
