...
import de.hybris.platform.cronjob.dto.CronJobHistoryDTO;
...
public class CronJobDTO extends ItemDTO
{
	...
	private CronJobHistoryDTO activeCronJobHistory = null;
	...
	public CronJobHistoryDTO getActiveCronJobHistory()
	{
	...
	public void setActiveCronJobHistory(final CronJobHistoryDTO activeCronJobHistory)
	{
		this.modifiedPropsSet.add("activeCronJobHistory");
