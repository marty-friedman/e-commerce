...
//@GraphNode(target = CartModel.class, factory = CartModelFactory.class, addNodes =
//{ DebitPaymentInfoDTO.class, CreditCardPaymentInfoDTO.class, InvoicePaymentInfoDTO.class, AdvancePaymentInfoDTO.class })
@GraphNode(target = CartModel.class, factory = GenericNodeFactory.class, uidProperties = "code")
@XmlRootElement(name = "cart")
public class CartDTO implements ModifiedProperties
{
	 ...
	 *           the entries to set
	 */
	public void setEntries(final List<CartEntryDTO> entries)
	{
