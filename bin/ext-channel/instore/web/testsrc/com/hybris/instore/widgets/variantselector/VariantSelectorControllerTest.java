...
import com.hybris.instore.widgets.ZkMockingTools;
...
import static com.hybris.instore.widgets.ZkMockingTools.mockZkEnvironment;
import static com.hybris.instore.widgets.variantselector.VariantSelectorController.SETTING_LISTBOX_MOLD;
...
public class VariantSelectorControllerTest extends AbstractWidgetUnitTest<VariantSelectorController>
{
	...
	{
		widgetSettings.put(SETTING_LISTBOX_MOLD, "default");
		...
		final List<VariantOptionQualifierData> qualifiers = Arrays.asList(variantOption1QualifierData, variantOption2QualifierData);

		Mockito.when(variantOptionData.getVariantOptionQualifiers()).thenReturn(qualifiers);

		final List<VariantOptionData> variantOptionList = Arrays.asList(variantOptionData,
