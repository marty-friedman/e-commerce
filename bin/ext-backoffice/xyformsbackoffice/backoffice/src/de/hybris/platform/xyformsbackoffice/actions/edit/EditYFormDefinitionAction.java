...
public class EditYFormDefinitionAction extends AbstractComponentWidgetAdapterAware implements CockpitAction<Object, String>
{
	...
	public ActionResult<String> perform(final ActionContext<Object> ctx)
	{
		...
		try
		{
			...
			{
				NotificationUtils.notifyUser(NotificationUtils.getWidgetNotificationSource(ctx), EDIT_YFORM_DEFINITION_COUNTERPART_ERROR, NotificationEvent.Level.FAILURE);
		...
		{
			NotificationUtils.notifyUser(NotificationUtils.getWidgetNotificationSource(ctx), EDIT_YFORM_DEFINITION_ERROR, NotificationEvent.Level.FAILURE, e);
			LOG.error(e);
			return new ActionResult<String>(ActionResult.ERROR);
		}
	}
