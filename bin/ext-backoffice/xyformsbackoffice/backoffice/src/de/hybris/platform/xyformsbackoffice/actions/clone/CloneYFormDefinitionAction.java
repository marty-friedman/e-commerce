...
public class CloneYFormDefinitionAction extends AbstractComponentWidgetAdapterAware implements CockpitAction<Object, String>
{
	...
	public static final String CLONE_YFORM_DEFINITION_ERROR = "cloneYFormDefinitionError";
	...
	public ActionResult<String> perform(final ActionContext<Object> ctx)
	{
		...
		{
			NotificationUtils.notifyUser(NotificationUtils.getWidgetNotificationSource(ctx), CLONE_YFORM_DEFINITION_ERROR, NotificationEvent.Level.FAILURE, e);
