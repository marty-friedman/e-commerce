...
public class CreateYFormDefinitionCounterpartController extends DefaultWidgetController
{
	...
	public void execute(final Object object)
	{
		...
		{
			NotificationUtils.notifyUser(NotificationUtils.getWidgetNotificationSource(getWidgetInstanceManager()), GENERIC_YFORM_DEFINITION_ERROR, NotificationEvent.Level.FAILURE, e);
			LOG.error(e, e);
		}
	}
