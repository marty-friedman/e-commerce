...
public class DefaultCipherService implements CipherService
{
	...
	protected void verifyPunchOutSession(final PunchOutSession punchoutSession) throws IllegalArgumentException
	{
	 ...
	 */
	protected static String encode(final String notEncoded)
	{
		try
		{
	 ...
	 */
	protected boolean verify(final String hash, final String userId, final PunchOutSession punchoutSession)
			throws IllegalArgumentException
	{
		...
		{
			final String msg = "Unable to verify hash. Missing parameters: [hash] or [userId]";
			LOG.info(msg);
			throw new IllegalArgumentException(msg);
		}
	 ...
	 */
	protected String getUnsecureText(final String userId, final PunchOutSession punchoutSession)
	{
