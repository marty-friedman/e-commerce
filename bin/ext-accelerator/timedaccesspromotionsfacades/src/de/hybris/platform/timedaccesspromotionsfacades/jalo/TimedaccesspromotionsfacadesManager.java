 ...
 */
package de.hybris.platform.timedaccesspromotionsfacades.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.timedaccesspromotionsfacades.constants.TimedaccesspromotionsfacadesConstants;
...
/**
 * This is the extension manager of the Timedaccesspromotionsfacades extension.
 */
public class TimedaccesspromotionsfacadesManager extends GeneratedTimedaccesspromotionsfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TimedaccesspromotionsfacadesManager.class.getName());
	 ...
	 */
	public static TimedaccesspromotionsfacadesManager getInstance()
	{
		return (TimedaccesspromotionsfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TimedaccesspromotionsfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TimedaccesspromotionsfacadesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TimedaccesspromotionsfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TimedaccesspromotionsfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TimedaccesspromotionsfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
