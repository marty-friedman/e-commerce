...
@UnitTest
public class AsBoostRulesReplaceMergeStrategyTest extends AbstractAsBoostRulesMergeStrategyTest
{
	...
	public void mergeBoostRules()
	{
		...
		assertNull(boostRule2Holder.getReplacedConfigurationUid());
	}
	...
	public void mergeBoostRulesWithDuplicates()
	{
		...
		assertNull(boostRule3Holder.getReplacedConfigurationUid());
		...
		assertNull(boostRule4Holder.getReplacedConfigurationUid());
	}
}