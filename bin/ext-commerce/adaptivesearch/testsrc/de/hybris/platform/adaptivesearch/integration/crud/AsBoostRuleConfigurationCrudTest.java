...
@IntegrationTest
public class AsBoostRuleConfigurationCrudTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/adaptivesearch/test/integration/crud/asBoostRuleConfigurationCrudTest.impex", CharEncoding.UTF_8);
	...
	@Test
	public void failToCreateMultipleBoostRuleConfigurationsWithSameUid() throws Exception
	{
		// given
		final AsBoostRuleModel boostRule1 = asConfigurationService.createConfiguration(AsBoostRuleModel.class);
		boostRule1.setCatalogVersion(onlineCatalogVersion);
