...
@UnitTest
public class AsBoostItemsAddBeforeMergeStrategyTest extends AbstractAsBoostRulesMergeStrategyTest
{
	private AsBoostItemsAddBeforeMergeStrategy mergeStrategy;

	@Before
	public void createMergeStrategy()
	{
		mergeStrategy = new AsBoostItemsAddBeforeMergeStrategy();
	...
	public void mergePromotedItems()
	{
		...
		final AsConfigurationHolder<AsPromotedItem, AbstractAsBoostItemConfiguration> promotedItem2Holder = promotedItems.get(0);
		assertSame(promotedItem2, promotedItem2Holder.getConfiguration());
		assertNull(promotedItem2Holder.getReplacedConfigurationUid());

		final AsConfigurationHolder<AsPromotedItem, AbstractAsBoostItemConfiguration> promotedItem1Holder = promotedItems.get(1);
	...
	public void mergePromotedItemsWithDuplicates()
	{
		...
		assertSame(promotedItem2, promotedItem2Holder.getConfiguration());
		assertEquals(excludedItem1.getUid(), promotedItem2Holder.getReplacedConfigurationUid());
	...
	public void mergeExcludedItems()
	{
		...
		final AsConfigurationHolder<AsExcludedItem, AbstractAsBoostItemConfiguration> excludedItem1Holder = excludedItems.get(1);
	...
	public void mergeExcludedItemsWithDuplicates()
	{
		...
		assertSame(excludedItem1, excludedItem1Holder.getConfiguration());
		assertEquals(promotedItem2.getUid(), excludedItem1Holder.getReplacedConfigurationUid());
