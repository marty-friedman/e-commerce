...
@IntegrationTest
public class AsSortExpressionCrudTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/adaptivesearch/test/integration/crud/asSortExpressionCrudTest.impex", CharEncoding.UTF_8);
	...
	@Test
	public void failToCreateMultipleSortExpressionsWithTheSameExpression() throws Exception
	{
		// given
		final AsSortExpressionModel sortExpression1 = asConfigurationService.createConfiguration(AsSortExpressionModel.class);
		sortExpression1.setCatalogVersion(onlineCatalogVersion);
	...
	@Test
	public void failToUpdateSortExpressionsWithTheExistingExpression() throws Exception
	{
		// given
		final AsSortExpressionModel sortExpression1 = asConfigurationService.createConfiguration(AsSortExpressionModel.class);
		sortExpression1.setCatalogVersion(onlineCatalogVersion);
		...
		final Optional<AsSortExpressionModel> createdSortExpressionOptional = asConfigurationService
				.getConfigurationForUid(AsSortExpressionModel.class, onlineCatalogVersion, UID2);

		final AsSortExpressionModel createdSortExpression = createdSortExpressionOptional.get();
		createdSortExpression.setExpression(INDEX_PROPERTY1);
