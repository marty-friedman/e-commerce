...
public class CatalogVersionSynchronizationTest extends ServicelayerTest
{
	...
	{
		importCsv("/adaptivesearch/test/integration/catalogVersionSynchronizationTest.impex", "utf-8");
	...
	{
		// given
		importCsv("/adaptivesearch/test/integration/catalogVersionSynchronizationTest_create_simpleSearchProfile.impex", "utf-8");
	...
	public void synchronizeSimpleSearchProfileAfterUpdate1() throws Exception
	{
		...
		// when
		performSynchronization(stagedCatalogVersion, onlineCatalogVersion);
		importCsv("/adaptivesearch/test/integration/catalogVersionSynchronizationTest_update1_simpleSearchProfile.impex", "utf-8");
		performSynchronization(stagedCatalogVersion, onlineCatalogVersion);
	...
	public void synchronizeSimpleSearchProfileAfterUpdate2() throws Exception
	{
		...
		// when
		performSynchronization(stagedCatalogVersion, onlineCatalogVersion);
		importCsv("/adaptivesearch/test/integration/catalogVersionSynchronizationTest_update2_simpleSearchProfile.impex", "utf-8");
		performSynchronization(stagedCatalogVersion, onlineCatalogVersion);
	...
	{
		// given
		importCsv("/adaptivesearch/test/integration/catalogVersionSynchronizationTest_create_catAwareSearchProfile.impex", "utf-8");
	...
	public void synchronizeCatAwareSearchProfileAfterUpdate1() throws Exception
	{
		...
		// when
		performSynchronization(stagedCatalogVersion, onlineCatalogVersion);
		importCsv("/adaptivesearch/test/integration/catalogVersionSynchronizationTest_update1_catAwareSearchProfile.impex",
				"utf-8");
		performSynchronization(stagedCatalogVersion, onlineCatalogVersion);
	...
	public void synchronizeCatAwareSearchProfileAfterUpdate2() throws Exception
	{
		...
		// when
		performSynchronization(stagedCatalogVersion, onlineCatalogVersion);
		importCsv("/adaptivesearch/test/integration/catalogVersionSynchronizationTest_update2_catAwareSearchProfile.impex",
				"utf-8");
		performSynchronization(stagedCatalogVersion, onlineCatalogVersion);
