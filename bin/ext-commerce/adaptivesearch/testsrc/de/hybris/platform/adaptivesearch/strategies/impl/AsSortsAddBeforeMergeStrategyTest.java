...
@UnitTest
public class AsSortsAddBeforeMergeStrategyTest extends AbstractAsSortsMergeStrategyTest
{
	private AsSortsAddBeforeMergeStrategy mergeStrategy;

	@Before
	public void createMergeStrategy()
	{
		mergeStrategy = new AsSortsAddBeforeMergeStrategy();
	...
	public void mergePromotedSorts()
	{
		...
		final AsConfigurationHolder<AsPromotedSort, AbstractAsSortConfiguration> promotedSort1Holder = promotedSorts.get(1);
	...
	public void mergeSortsWithDuplicates()
	{
		...
		final AsConfigurationHolder<AsSort, AbstractAsSortConfiguration> sort3Holder = sorts.get(2);
	...
	public void mergeExcludedSortsWithDuplicates()
	{
		...
		final AsConfigurationHolder<AsExcludedSort, AbstractAsSortConfiguration> excludedSort3Holder = excludedSorts.get(2);
		assertSame(excludedSort3, excludedSort3Holder.getConfiguration());
		assertThat(excludedSort3Holder.getConfiguration().getExpressions()).containsExactly(excludedSort3Expression1);
		assertNull(excludedSort3Holder.getReplacedConfigurationUid());
	}
