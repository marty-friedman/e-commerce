...
public class DefaultAsCacheStrategyIntegrationTest extends ServicelayerTransactionalTest
{
	...
	@Test
	public void getWithInvalidation()
	{
		// given
		final String cacheKeyFragment = "fragmentWithInvalidation";
		final AsCacheKey cacheKey = new DefaultAsCacheKey(AsCacheScope.LOAD, cacheKeyFragment);

		// when
		final Object cachedValue1 = defaultAsCacheStrategy.getWithLoader(cacheKey, key -> CACHE_VALUE1);
		...
		version.setVersion("Online");
		modelService.saveAll();

		final AsSimpleSearchProfileModel searchProfile = new AsSimpleSearchProfileModel();
		searchProfile.setCode("test");
		searchProfile.setIndexType("testIndex");
		searchProfile.setCatalogVersion(version);
		modelService.save(searchProfile);

		final Object cachedValue2 = defaultAsCacheStrategy.getWithLoader(cacheKey, key -> CACHE_VALUE2);
	...
	@Test
	public void getWithDifferentScopes1()
	{
		// given
	...
	@Test
	public void getWithDifferentScopes2()
	{
		// given
		final String cacheKeyFragment = "fragmentScopes2";
		final AsCacheKey cacheKey1 = new DefaultAsCacheKey(AsCacheScope.LOAD, cacheKeyFragment);
		final AsCacheKey cacheKey2 = new DefaultAsCacheKey(AsCacheScope.MERGE, cacheKeyFragment);
	...
	@Test
	public void getWithDifferentScopes3()
	{
		// given
		final String cacheKeyFragment = "fragmentScopes3";
		final AsCacheKey cacheKey1 = new DefaultAsCacheKey(AsCacheScope.CALCULATION, cacheKeyFragment);
		final AsCacheKey cacheKey2 = new DefaultAsCacheKey(AsCacheScope.MERGE, cacheKeyFragment);
