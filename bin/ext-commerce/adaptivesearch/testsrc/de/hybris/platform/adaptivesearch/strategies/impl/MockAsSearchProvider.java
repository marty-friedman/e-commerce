...
public class MockAsSearchProvider implements AsSearchProvider, InitializingBean
{
	...
	public void afterPropertiesSet()
	{
		...
		indexProperty1.setAllowFacet(true);
		...
		indexProperty2.setAllowFacet(true);
		...
		indexProperty3.setAllowFacet(true);
		...
		indexProperty4.setAllowFacet(false);
	...
	@Override
	public List<AsCatalogVersionData> getCatalogVersions(final String indexConfiguration, final String indexType)
	{
		return Collections.emptyList();
	}
	...
	@Override
	public List<AsLanguageData> getLanguages(final String indexConfiguration, final String indexType)
	{
		return Collections.emptyList();
	}
	...
	@Override
	public List<AsCurrencyData> getCurrencies(final String indexConfiguration, final String indexType)
	{
		return Collections.emptyList();
	}
	...
	public boolean isValidSortExpression(final String indexType, final String expression)
	{
		return StringUtils.equals(expression, SCORE_EXPRESSION) || StringUtils.equals(expression, INDEX_PROPERTY_CODE1)
				|| StringUtils.equals(expression, INDEX_PROPERTY_CODE2)
				|| StringUtils.equals(expression, INDEX_PROPERTY_CODE3);
	}

	@Override
	public AsSearchResultData search(final AsSearchProfileContext context, final String searchText, final int activePage,
			final int pageSize) throws AsException
	{
