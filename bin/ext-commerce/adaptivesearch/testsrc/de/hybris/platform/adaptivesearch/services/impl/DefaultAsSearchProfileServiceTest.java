...
public class DefaultAsSearchProfileServiceTest
{
	...
	public void getByIndexTypesAndCatalogVersions()
	{
		...
		when(asSearchProfileDao.findSearchProfilesByIndexTypesAndCatalogVersions(Collections.singletonList(INDEX_TYPE), Collections.singletonList(catalogVersion)))
		...
		final List<AbstractAsSearchProfileModel> searchProfiles = defaultAsSearchProfileService
				.getSearchProfilesForIndexTypesAndCatalogVersions(Collections.singletonList(INDEX_TYPE), Collections.singletonList(catalogVersion));
