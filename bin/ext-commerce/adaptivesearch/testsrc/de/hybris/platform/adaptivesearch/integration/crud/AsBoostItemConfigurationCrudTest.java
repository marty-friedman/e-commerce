...
@IntegrationTest
public class AsBoostItemConfigurationCrudTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/adaptivesearch/test/integration/crud/asBoostItemConfigurationCrudTest.impex", CharEncoding.UTF_8);
	...
	@Test
	public void failToCreateMultipleBoostItemConfigurationsSameUid() throws Exception
	{
		// given
		final AsPromotedItemModel promotedItem = asConfigurationService.createConfiguration(AsPromotedItemModel.class);
		promotedItem.setCatalogVersion(onlineCatalogVersion);
	...
	@Test
	public void failToCreateMultipleBoostItemConfigurationsSameItem() throws Exception
	{
		// given
		final AsPromotedItemModel promotedItem = asConfigurationService.createConfiguration(AsPromotedItemModel.class);
		promotedItem.setCatalogVersion(onlineCatalogVersion);
