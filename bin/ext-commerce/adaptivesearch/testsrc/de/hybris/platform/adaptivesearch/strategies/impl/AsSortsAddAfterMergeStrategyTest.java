...
@UnitTest
public class AsSortsAddAfterMergeStrategyTest extends AbstractAsSortsMergeStrategyTest
{
	private AsSortsAddAfterMergeStrategy mergeStrategy;

	@Before
	public void createMergeStrategy()
	{
		mergeStrategy = new AsSortsAddAfterMergeStrategy();
	...
	public void mergePromotedSorts()
	{
		...
		assertNull(promotedSort1Holder.getReplacedConfigurationUid());
		...
		assertNull(promotedSort2Holder.getReplacedConfigurationUid());
	}
	...
	public void mergePromotedSortsWithDuplicates()
	{
		...
		assertThat(promotedSort1Holder.getConfiguration().getExpressions()).containsExactly(promotedSort1Expression1,
				promotedSort1Expression2);
		assertEquals(sort1.getUid(), promotedSort1Holder.getReplacedConfigurationUid());

		final AsConfigurationHolder<AsPromotedSort, AbstractAsSortConfiguration> promotedSort2Holder = promotedSorts.get(1);
		assertSame(promotedSort2, promotedSort2Holder.getConfiguration());
		assertThat(promotedSort2Holder.getConfiguration().getExpressions()).containsExactly(promotedSort2Expression1,
				promotedSort2Expression2);
		assertEquals(excludedSort1.getUid(), promotedSort2Holder.getReplacedConfigurationUid());
		...
		assertNull(sort2Holder.getReplacedConfigurationUid());
		...
		assertNull(excludedSort2Holder.getReplacedConfigurationUid());

		final AsConfigurationHolder<AsExcludedSort, AbstractAsSortConfiguration> excludedSort3Holder = excludedSorts.get(1);
		...
		assertNull(excludedSort3Holder.getReplacedConfigurationUid());
	}
	...
	public void mergeSorts()
	{
		...
		assertThat(sort1Holder.getConfiguration().getExpressions()).containsExactly(sort1Expression1, sort1Expression2);
		assertNull(sort1Holder.getReplacedConfigurationUid());
	...
	public void mergeSortsWithDuplicates()
	{
		...
		assertEquals(3, getTarget().getSorts().size());
		final List<AsConfigurationHolder<AsSort, AbstractAsSortConfiguration>> sorts = ((MergeMap<String, AsConfigurationHolder<AsSort, AbstractAsSortConfiguration>>) getTarget()
				.getSorts()).orderedValues();

		final AsConfigurationHolder<AsSort, AbstractAsSortConfiguration> sort3Holder = sorts.get(0);
		assertSame(sort3, sort3Holder.getConfiguration());
		assertThat(sort3Holder.getConfiguration().getExpressions()).containsExactly(sort3Expression1);
		assertNull(sort3Holder.getReplacedConfigurationUid());

		final AsConfigurationHolder<AsSort, AbstractAsSortConfiguration> sort1Holder = sorts.get(1);
		assertSame(sort1, sort1Holder.getConfiguration());
		assertThat(sort1Holder.getConfiguration().getExpressions()).containsExactly(sort1Expression1);
		assertEquals(promotedSort1.getUid(), sort1Holder.getReplacedConfigurationUid());

		final AsConfigurationHolder<AsSort, AbstractAsSortConfiguration> sort2Holder = sorts.get(2);
		assertSame(sort2, sort2Holder.getConfiguration());
		assertThat(sort2Holder.getConfiguration().getExpressions()).containsExactly(sort2Expression1, sort2Expression2);
		assertEquals(excludedSort1.getUid(), sort2Holder.getReplacedConfigurationUid());
	...
	public void mergeExcludedSorts()
	{
		...
		assertNull(excludedSort1Holder.getReplacedConfigurationUid());
	...
	public void mergeExcludedSortsWithDuplicates()
	{
		...
		final AsConfigurationHolder<AsPromotedSort, AbstractAsSortConfiguration> promotedSort3Holder = promotedSorts.get(1);
		assertSame(promotedSort3, promotedSort3Holder.getConfiguration());
		assertThat(promotedSort3Holder.getConfiguration().getExpressions()).containsExactly(promotedSort3Expression1);
		assertNull(promotedSort3Holder.getReplacedConfigurationUid());
		...
		assertEquals(3, getTarget().getExcludedSorts().size());
		final List<AsConfigurationHolder<AsExcludedSort, AbstractAsSortConfiguration>> excludedSorts = ((MergeMap<String, AsConfigurationHolder<AsExcludedSort, AbstractAsSortConfiguration>>) getTarget()
				.getExcludedSorts()).orderedValues();
		...
		final AsConfigurationHolder<AsExcludedSort, AbstractAsSortConfiguration> excludedSort1Holder = excludedSorts.get(1);
		assertSame(excludedSort1, excludedSort1Holder.getConfiguration());
		assertThat(excludedSort1Holder.getConfiguration().getExpressions()).containsExactly(excludedSort1Expression1,
				excludedSort1Expression2);
		assertEquals(promotedSort1.getUid(), excludedSort1Holder.getReplacedConfigurationUid());

		final AsConfigurationHolder<AsExcludedSort, AbstractAsSortConfiguration> excludedSort2Holder = excludedSorts.get(2);
		assertSame(excludedSort2, excludedSort2Holder.getConfiguration());
		assertThat(excludedSort2Holder.getConfiguration().getExpressions()).containsExactly(excludedSort2Expression1,
				excludedSort2Expression2);
		assertEquals(sort1.getUid(), excludedSort2Holder.getReplacedConfigurationUid());
	}
}