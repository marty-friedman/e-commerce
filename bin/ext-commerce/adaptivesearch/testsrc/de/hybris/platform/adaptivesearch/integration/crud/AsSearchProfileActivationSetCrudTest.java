...
@IntegrationTest
public class AsSearchProfileActivationSetCrudTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/adaptivesearch/test/integration/crud/asSearchProfileActivationSetCrudTest.impex", CharEncoding.UTF_8);
	}
