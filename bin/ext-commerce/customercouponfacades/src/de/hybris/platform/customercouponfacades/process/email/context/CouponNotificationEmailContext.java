...
public class CouponNotificationEmailContext extends AbstractEmailContext<CouponNotificationProcessModel>
{
	...
	public void init(final CouponNotificationProcessModel businessProcessModel, final EmailPageModel emailPageModel)
	{
		...
		updateCouponNotificationType(businessProcessModel, emailLocale);
		updateCouponValidDate(businessProcessModel, emailLocale);
		updateCouponLink(businessProcessModel, emailLocale);
	}
	...
	protected void updateCouponLink(final CouponNotificationProcessModel businessProcessModel, final Locale emailLocale)
	{
	...
	protected void updateCouponValidDate(final CouponNotificationProcessModel businessProcessModel, final Locale emailLocale)
	{
		final CustomerCouponData couponData = getCustomerCouponConverter()
				.convert(businessProcessModel.getCouponNotification().getCustomerCoupon());
