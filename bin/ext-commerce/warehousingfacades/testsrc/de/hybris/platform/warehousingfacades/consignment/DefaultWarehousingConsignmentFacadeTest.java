 ...
 */
package de.hybris.platform.warehousingfacades.consignment;
...
public class DefaultWarehousingConsignmentFacadeTest
{
	...
	{
		//When
		warehousingConsignmentFacade.pickConsignment("WrongCode");
	}
	...
	{
		//When
		warehousingConsignmentFacade.packConsignment("WrongCode");
	}
	...
	{
		//When
		warehousingConsignmentFacade.getExportForm("WrongCode");
	}
	...
	{
		//When
		warehousingConsignmentFacade.getShippingLabel("WrongCode");
	}
	...
	{
		//When
		warehousingConsignmentFacade.getReturnShippingLabel("WrongCode");
	}
	...
	{
		//When
		warehousingConsignmentFacade.getReturnForm("WrongCode");
	}
	...
	public void testConsolidatedPickSlipWhenConsignmentCodeIsWrong()
	{
		//Given
		consignmentCodeDataList = new ConsignmentCodeDataList();
		consignmentCodeDataList.setCodes(Collections.singletonList("WrongCode"));
