 ...
 */
package de.hybris.platform.customerticketingfacades.jalo;
...
/**
 * This is the extension manager of the customerticketingfacades extension.
 */
public class CustomerticketingfacadesManager extends GeneratedCustomerticketingfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CustomerticketingfacadesManager.class.getName());
	 ...
	 */
	public static CustomerticketingfacadesManager getInstance()
	{
		return (CustomerticketingfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CustomerticketingfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CustomerticketingfacadesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CustomerticketingfacadeManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CustomerticketingfacadeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CustomerticketingfacadeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
