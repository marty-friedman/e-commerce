...
public class DefaultAlipayPaymentTransactionStrategyTest extends ServicelayerTransactionalTest
{
	...
	public void testUpdateForRefundNotification()
	{
		...
		final List<AlipayRefundData> alipayRefundData = new ArrayList<AlipayRefundData>();
	...
	public void testCreateTransactionEntryForNewRequest()
	{
		...
		final List<PaymentTransactionModel> transactionModels = new ArrayList<>();
		...
		final List<PaymentTransactionEntryModel> entries = emptyOrder.getPaymentTransactions().get(0).getEntries();
		assertEquals(1, entries.size());
		final AlipayPaymentTransactionEntryModel entry = (AlipayPaymentTransactionEntryModel) entries.get(0);
