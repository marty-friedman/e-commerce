...
public class DefaultBundleCommerceCartServiceIntegrationTest extends DefaultSubscriptionCommerceCartServiceIntegrationTest
{
	...
	private ProductModel subscriptionProductModelActivationFee;
	private ProductModel subscriptionProductModelServiceFeeMonth;
	...
	private ProductModel subscriptionProductModelYStarter200_1y;
	...
	public void testAddToCart2BundleProducts() throws CommerceCartModificationException
	{
		...
		for (final CommerceCartModification mod : results)
		{
			...
			if (subscriptionProductService.isSubscription(mod.getEntry().getProduct()))
			{
				...
				assertEquals(childCartEntry.getProduct().getSubscriptionTerm().getBillingPlan()
	...
	public void testAddToCart2BundleProductsNoStock() throws CommerceCartModificationException
	{
		...
		for (final CommerceCartModification mod : results2)
		{
			...
			else
			{
				...
				assertEquals(childCartEntry2.getProduct().getSubscriptionTerm().getBillingPlan()
	...
	private void setupProducts()
	{
		...
		subscriptionProductModelYStarter200_1y = productService.getProductForCode(catalogVersionModel,
		...
		subscriptionProductModelActivationFee = productService.getProductForCode(catalogVersionModel, ACTIVATION_FEE_PRODUCT_CODE);
		subscriptionProductModelServiceFeeMonth = productService.getProductForCode(catalogVersionModel, SERVICE_FEE_PRODUCT_CODE);
