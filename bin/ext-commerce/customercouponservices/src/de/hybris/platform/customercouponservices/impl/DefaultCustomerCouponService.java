...
/**
 * An implementation of {@link CustomerCouponService}
 */
public class DefaultCustomerCouponService extends DefaultCouponService implements CustomerCouponService
{
	...
	{
		validateParameterNotNull(couponCode, "coupon code code must not be null");
	...
	{
		validateParameterNotNull(couponCode, "Coupon Code can not be null");
		final List<CouponNotificationModel> couponNotificationList = getCouponNotificationDao().findCouponNotificationByCouponCode(
				couponCode);
	...
	{
		validateParameterNotNull(couponCode, "Coupon Code can not be null");
		final List<CouponNotificationModel> couponNotification = getCouponNotificationDao().findCouponNotificationByCouponCode(
				couponCode);
	...
	{
		validateParameterNotNull(couponCode, "coupon code code must not be null");
		final List<CouponNotificationModel> couponNotifications = getCouponNotificationDao().findCouponNotificationByCouponCode(
				couponCode);
