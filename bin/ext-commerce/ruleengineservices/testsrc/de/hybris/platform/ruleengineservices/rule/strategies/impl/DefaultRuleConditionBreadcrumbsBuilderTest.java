...
public class DefaultRuleConditionBreadcrumbsBuilderTest
{
	...
	public void setUp()
	{
		...
		conditionDefinitions = new HashMap<String, RuleConditionDefinitionData>();
		...
		Mockito.when(l10NService.getLocalizedString(buildLocalizationKey(RuleGroupOperator.AND)))
				.thenReturn(RuleGroupOperator.AND.toString());
		Mockito.when(l10NService.getLocalizedString(buildLocalizationKey(RuleGroupOperator.OR)))
