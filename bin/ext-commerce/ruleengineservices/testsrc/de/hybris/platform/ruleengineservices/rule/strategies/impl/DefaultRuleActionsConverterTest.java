...
public class DefaultRuleActionsConverterTest
{
	...
	public void setUp() throws Exception
	{
		...
		ruleActionsConverter = new DefaultRuleActionsConverter();
		ruleActionsConverter.setRuleActionsRegistry(ruleActionsRegistry);
		ruleActionsConverter.setRuleParameterValueConverter(ruleParameterValueConverter);
		ruleActionsConverter.setRuleParameterUuidGenerator(ruleParameterUuidGenerator);
