...
public class DefaultRuleConditionsConverterTest
{
	...
	public void setUp() throws Exception
	{
		...
		ruleConditionsConverter = new DefaultRuleConditionsConverter();
		ruleConditionsConverter.setRuleConditionsRegistry(ruleConditionsRegistry);
		ruleConditionsConverter.setRuleParameterValueConverter(ruleParameterValueConverter);
		ruleConditionsConverter.setRuleParameterUuidGenerator(ruleParameterUuidGenerator);
