...
public class RuleGroupExecutionRrdPopulatorUnitTest
{
	...
	public void setUp() throws Exception
	{
		...
		when(ruleGroupDao.findRuleGroupByCode(DEFAULT_RULE_GROUP_CODE)).thenReturn(Optional.of(defaultRuleGroupModel));
	...
	public void testDefaultRuleGroupCode()
	{
		...
		assertEquals(DEFAULT_RULE_GROUP_IS_EXCLUSIVE, target.isExclusive());
	}
}
