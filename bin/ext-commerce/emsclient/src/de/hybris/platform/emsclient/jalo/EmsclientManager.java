 ...
 */
package de.hybris.platform.emsclient.jalo;
...
import de.hybris.platform.emsclient.constants.EmsclientConstants;



/**
 * This is the extension manager of the Emsclient extension.
 */
public class EmsclientManager extends GeneratedEmsclientManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EmsclientManager.class.getName());
	 ...
	 */
	public static EmsclientManager getInstance()
	{
		return (EmsclientManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EmsclientConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EmsclientManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EmsclientManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EmsclientManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EmsclientManager called, current tenant: " + getTenant().getTenantID());
		}
	}
