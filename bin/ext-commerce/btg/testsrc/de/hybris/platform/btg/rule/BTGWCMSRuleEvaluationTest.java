...
public class BTGWCMSRuleEvaluationTest extends BTGIntegrationTest
{
	...
	private RuleDataContainer<String> getRuleDataContainerForProducts()
	{
		...
		final ViewedProductsOperandValueProvider vpovp = this.getApplicationContext().getBean("viewedProductsOperandValueProvider",
	...
	private RuleDataContainer<HashMap<String, String[]>> getRuleDataContainerForUrlParameters()
	{
		...
		final UrlParameterOperandValueProvider operandValueProvider = this.getApplicationContext().getBean("urlParameterOperandValueProvider",
