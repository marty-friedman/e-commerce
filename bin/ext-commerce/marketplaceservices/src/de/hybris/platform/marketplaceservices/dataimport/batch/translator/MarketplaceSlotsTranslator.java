...
public class MarketplaceSlotsTranslator extends AbstractValueTranslator
{
	...
	public void init(final StandardColumnDescriptor descriptor)
	{
		...
		setVendorCMSPageService((VendorCMSPageService) Registry.getApplicationContext().getBean(VENDOR_CMSPAGE_SERVICE));
		setVendorCMSStrategy((VendorCMSStrategy) Registry.getApplicationContext().getBean(VENDORCMS_STRATEGY));
