...
public class VendorRestriction extends GeneratedVendorRestriction
{
	...
	private final static Logger LOG = Logger.getLogger(VendorRestriction.class.getName());
	...
	public String getDescription(SessionContext ctx)
	{
		...
		if (vendor != null)
		{
			String localizedString = Localization.getLocalizedString("type.CMSVendorRestriction.description.text");
