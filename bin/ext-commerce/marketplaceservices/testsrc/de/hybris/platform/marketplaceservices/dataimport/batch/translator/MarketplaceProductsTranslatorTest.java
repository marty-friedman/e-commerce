...
@PrepareForTest(
{ Registry.class, ProductManager.class })
public class MarketplaceProductsTranslatorTest
{
	...
	private MarketplaceProductsTranslator translator;
	...
	public void setUp()
	{
		...
		PowerMockito.mockStatic(ProductManager.class);
		PowerMockito.when(Registry.getApplicationContext()).thenReturn(applicationContext);
		PowerMockito.when(ProductManager.getInstance()).thenReturn(productManager);
		translator = new MarketplaceProductsTranslator();
