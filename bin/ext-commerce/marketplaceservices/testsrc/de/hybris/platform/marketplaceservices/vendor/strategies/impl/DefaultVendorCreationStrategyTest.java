...
public class DefaultVendorCreationStrategyTest extends ServicelayerTransactionalTest
{
	...
	private static final String CATALOG_VERSIONG_NAME = "vendor.product.catalog.version";
	...
	public void testCreatCatalog()
	{
		...
		final String catalogVersionName = getStringForConfiguration(CATALOG_VERSIONG_NAME);
