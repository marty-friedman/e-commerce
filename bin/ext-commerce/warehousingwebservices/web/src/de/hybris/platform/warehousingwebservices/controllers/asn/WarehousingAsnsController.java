...
public class WarehousingAsnsController extends WarehousingBaseController
{
	 ...
	 * @throws {@link WebserviceValidationException}
	 */
	...
	public AsnWsDTO createAsn(@ApiParam(value = "AsnWsDTO containing information about the asn to be created",required = true)@RequestBody final AsnWsDTO asnWsDTO,
	...
	public AsnWsDTO confirmAsnReceipt(@ApiParam(value = "Internal Id for the advanced shipping notice to be confirmed", required = true)@PathVariable @NotNull final String internalId,
			@ApiParam(value = "Fields mapping level", required = false)@RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
	 ...
	 */
	@RequestMapping(value = "{internalId}/cancel", method = RequestMethod.POST, consumes = {
			MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_JSON_VALUE }, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE })
	@ResponseStatus(HttpStatus.ACCEPTED)
	@ResponseBody
	@ApiOperation(value = "Cancels an advanced shipping notice",response = AsnWsDTO.class)
	public AsnWsDTO cancelAsn(@ApiParam(value = "Internal Id for the advanced shipping notice to be confirmed", required = true)@PathVariable @NotNull final String internalId,
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
