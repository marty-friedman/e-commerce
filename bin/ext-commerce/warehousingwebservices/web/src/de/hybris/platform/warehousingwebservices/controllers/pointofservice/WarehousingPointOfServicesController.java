...
public class WarehousingPointOfServicesController extends WarehousingBaseController
{
	...
	public WarehouseSearchPageWsDto getWarehousesForPointOfService(
			@ApiParam(value = "The name of the point of service", required = true) @PathVariable final String pointOfService,
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields,
			...
			@ApiParam(value = "Sort parameter", required = false) @RequestParam(required = false, defaultValue = DEFAULT_SORT) final String sort)
	{
		...
		final SearchPageData<WarehouseData> warehouses = warehousingPointOfServiceFacade
				.getWarehousesForPointOfService(pageableData, pointOfService);
	...
	public PointOfServiceWsDTO updatePointOfServiceWithWarehouses(@ApiParam(value = "The WarehouseCodesWsDto that contains a list of valid warehouse codes",required = true)@RequestBody WarehouseCodesWsDto warehouseCodes,
	...
	public PointOfServiceWsDTO deleteWarehousesFromPointOfService(@ApiParam(value = "The name of the point of service", required = true)@NotNull @PathVariable final String pointOfServiceName,
	...
	public PointOfServiceWsDTO updatePointOfServiceWithAddress(@ApiParam(value = "The AddressWsDTO object to update the point of service with", required = true)@RequestBody final AddressWsDTO address,
			@ApiParam(value = "The name of the point of service", required = true)@NotNull @PathVariable final String pointOfServiceName,
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
			throws WebserviceValidationException
	{
