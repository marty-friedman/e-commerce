...
public class WarehousingStockLevelsController extends WarehousingBaseController
{
	...
	public StockLevelSearchPageWsDto getStockLevelsForWarehouseCode(@ApiParam(value = "The code for the warehouse",required = true) @PathVariable final String code,
			...
			@ApiParam(value = "Sort parameter", required = false) @RequestParam(required = false, defaultValue = DEFAULT_SORT) final String sort)
	{
	...
	public StockLevelWsDto createStockLevel(@ApiParam(value = "The stocklevel object to be created", required = true)@RequestBody final StockLevelWsDto stockLevelWsDto,
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	...
	public StockLevelAdjustmentsWsDTO createStockLevelAdjustment(@ApiParam(value = "Product Code", required = true)@PathVariable final String productCode,
			@ApiParam(value = "Warehouse Code", required = true)@PathVariable final String warehouseCode, @ApiParam(value = "Bin Code")@RequestParam(required = false) final String binCode,
			@ApiParam(value = "Release Date", required = false)@RequestParam(required = false) final String releaseDate,
			@ApiParam(value = "List of stockLevel Adjustments", required = true)@RequestBody final StockLevelAdjustmentsWsDTO stockLevelAdjustmentsWsDTO) throws WebserviceValidationException
	{
