...
public class OmsOrdersController extends OmsBaseController
{
	...
	public OrderSearchPageWsDto getOrders(
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields,
			@ApiParam(value = "Current page number", required = false) @RequestParam(required = false, defaultValue = "0") final int currentPage,
			@ApiParam(value = "Number of items to be displayed per page", required = false) @RequestParam(required = false, defaultValue = "10") final int pageSize,
			@ApiParam(value = "Method in which to sort results", required = false) @RequestParam(required = false, defaultValue = "asc") final String sort)
	{
	...
	public OrderWsDTO getOrderForCode(@ApiParam(value = "The order code") @PathVariable final String code,
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
	...
	public OrderSearchPageWsDto getOrdersByStatus(
			@ApiParam(value = "List of desired order statuses") @PathVariable final String orderStatuses,
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields,
			@ApiParam(value = "Current page number", required = false) @RequestParam(required = false, defaultValue = DEFAULT_CURRENT_PAGE) final int currentPage,
			@ApiParam(value = "Number of items to be displayed per page", required = false) @RequestParam(required = false, defaultValue = DEFAULT_PAGE_SIZE) final int pageSize,
			@ApiParam(value = "Method in which to sort results", required = false) @RequestParam(required = false, defaultValue = DEFAULT_SORT) final String sort)
			throws WebserviceValidationException
	{
	...
	public OrderEntrySearchPageWsDTO getOrderEntriesForOrderCode(@ApiParam(value = "Order code") @PathVariable final String code,
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields,
			@ApiParam(value = "Current page number", required = false) @RequestParam(required = false, defaultValue = DEFAULT_CURRENT_PAGE) final int currentPage,
			@ApiParam(value = "Number of items to display per page", required = false) @RequestParam(required = false, defaultValue = DEFAULT_PAGE_SIZE) final int pageSize,
			@ApiParam(value = "Method in which to sort results", required = false) @RequestParam(required = false, defaultValue = DEFAULT_SORT) final String sort)
	{
		final PageableData pageableData = createPageable(currentPage, pageSize, sort);
	...
	public OrderEntryWsDTO getOrderEntryForOrderCodeAndEntryNumber(@ApiParam(value = "Order code") @PathVariable final String code,
			@ApiParam(value = "Order entry number") @PathVariable final String entryNumber,
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
	...
	public FraudReportListWsDTO getOrderFraudReports(@ApiParam(value = "Order code") @PathVariable final String code,
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
	...
	@RequestMapping(value = "/{code}/cancel", method = RequestMethod.POST, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(value = "Creates an order cancellation in the system")
			...
			@ApiParam(value = "Order code", required = true) @PathVariable @NotNull final String code)
	{
		...
		getOmsOrderFacade().createRequestOrderCancel(orderCancelRequestData);
	}
	 ...
	 */
	@RequestMapping(value = "/{code}/manual/void-payment", method = RequestMethod.POST, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseStatus(HttpStatus.OK)
	 ...
	 * 		the {@link OrderModel#CODE} for the order to be released
	 */
	@RequestMapping(value = "/{code}/manual/commit-tax", method = RequestMethod.POST, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseStatus(HttpStatus.OK)
