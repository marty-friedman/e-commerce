...
public class OmsReturnsController extends OmsBaseController
{
	...
	public ReturnSearchPageWsDTO getReturnsByStatus(
			@ApiParam(value = "Set of desired return statuses") @PathVariable final String returnStatuses,
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields,
			@ApiParam(value = "Current page number", required = false) @RequestParam(required = false, defaultValue = DEFAULT_CURRENT_PAGE) final int currentPage,
			@ApiParam(value = "Number of items to be displayed per page", required = false) @RequestParam(required = false, defaultValue = DEFAULT_PAGE_SIZE) final int pageSize,
			@ApiParam(value = "Method in which to sort results", required = false) @RequestParam(required = false, defaultValue = DEFAULT_SORT) final String sort)
	...
	public ReturnRequestWsDTO getReturnForReturnCode(@ApiParam(value = "Return request code") @PathVariable final String code,
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
	...
	public ReturnEntrySearchPageWsDTO getReturnEntriesForOrderCode(
			@ApiParam(value = "Return request code") @PathVariable final String code,
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields,
			@ApiParam(value = "Current page number", required = false) @RequestParam(required = false, defaultValue = DEFAULT_CURRENT_PAGE) final int currentPage,
	...
	public ReturnRequestWsDTO createReturnRequest(
			@ApiParam(value = "The ReturnRequestWsDTO holding all required information to create a return request") @RequestBody final ReturnRequestWsDTO returnRequestWsDTO,
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
	...
	public void approveReturnRequest(@ApiParam(value = "Return request code") @PathVariable final String code)
	{
	...
	public void cancelReturnRequest(
			@ApiParam(value = "The CancelReturnRequestWsDTO containing information about the return request cancellation") @RequestBody final CancelReturnRequestWsDTO cancelReturnRequestWsDTO)
			throws WebserviceValidationException
	{
