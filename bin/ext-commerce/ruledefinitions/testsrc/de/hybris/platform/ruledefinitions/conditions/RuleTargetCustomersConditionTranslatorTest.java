...
public class RuleTargetCustomersConditionTranslatorTest
{
	...
	public void testTranslateNotOperatorCustomerCondition()
	{
		...
		assertThat(groupConditions.get(1), instanceOf(RuleIrAttributeCondition.class));
		final RuleIrAttributeCondition ruleIrAttributeCustomerCondition = (RuleIrAttributeCondition) groupConditions.get(1);
		checkCustomerCondition(ruleIrAttributeCustomerCondition);
