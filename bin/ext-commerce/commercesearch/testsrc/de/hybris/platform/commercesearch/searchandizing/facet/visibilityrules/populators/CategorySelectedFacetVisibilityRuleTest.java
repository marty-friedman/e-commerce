...
public class CategorySelectedFacetVisibilityRuleTest
{
	...
	public void shouldFilterIfCategoryNotInResult()
	{
		...
		final FacetVisibilityRulesService mockFacetVisibilityRulesService = Mockito.mock(FacetVisibilityRulesService.class);
		...
		final AbstractFacetVisibilityRule rule = new CategorySelectedFacetVisibilityRule(new SolrCategorySelectedRuleEvaluator(),
				condition, categories);

		resultMap.put(indexedProperty, Lists.newArrayList(rule));
		Mockito.when(mockFacetVisibilityRulesService.getAllFacetVisibilityRulesForIndexedType(indexedType, facetSearchConfig))
