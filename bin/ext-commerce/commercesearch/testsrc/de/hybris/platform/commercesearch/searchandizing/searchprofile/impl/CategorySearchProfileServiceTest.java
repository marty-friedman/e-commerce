...
public class CategorySearchProfileServiceTest
{
	...
	public void setUp()
	{
		...
		categorySearchProfileService.setSolrFacetSearchConfigDao(solrFacetSearchConfigDao);
	...
	public void shouldReturnExactReconfigurationForSpecificCategory()
	{
		...
		given(guidedNavConfigDao.findCategorySolrSearchProfiles(any(SolrIndexedTypeModel.class), anyString())).willReturn(
				categorySearchProfileModels);
	...
	public void shouldReturnInheritedReconfigurationForSpecificCategory()
	{
		...
		given(solrFacetSearchConfigDao.findFacetSearchConfigByName(anyString())).willReturn(facetSearchConfigModel);
		given(commerceCategoryService.getPathsForCategory(any(CategoryModel.class))).willReturn(orphanCategoryPath);
		given(guidedNavConfigDao.getSolrFacetReconfigSearchProfiles(anyCollection(), any(SolrIndexedTypeModel.class))).willReturn(
				categorySearchProfileModels);
