...
public class DefaultRuleEngineKieModuleSwapperUnitTest
{
	...
	public void testSwitchKieModuleExecutePostTasks()
	{
		...
		final List<Object> resultsAccumulator = moduleSwapper.switchKieModule(droolsModule,
	...
	public void testSwitchKieModuleAsyncExecutePostTasksWhenCompleted() throws InterruptedException
	{
		...
		moduleSwapper.switchKieModuleAsync(MODULE_NAME, kieContainerListener, resultsAccumulator,
	...
	{
		return new Thread(moduleSwapper.switchKieModuleRunnableTask(MODULE_NAME, kieContainerListener,
	...
	private void setUpForIncrementalRuleEngineUpdate()
	{
		...
		when(contentMatchRulesFilter.apply(anyCollectionOf(String.class), eq(1L)))
