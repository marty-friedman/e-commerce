...
public class DefaultOmsOrderFacade extends OmsBaseFacade implements OmsOrderFacade
{
	...
	protected static final Logger LOGGER = LoggerFactory.getLogger(DefaultOmsOrderFacade.class);
	...
	@Override
	public void createRequestOrderCancel(final OrderCancelRequestData orderCancelRequestData)
	{
		...
		else
		{
			try
			{
				orderCancelService.requestOrderCancel(buildOrderCancelRequest(orderCancelRequestData, order), user);
			}
