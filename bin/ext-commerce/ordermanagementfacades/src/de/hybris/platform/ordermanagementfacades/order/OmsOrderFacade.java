...
public interface OmsOrderFacade
{
	 ...
	 * 		the {@link de.hybris.platform.ordermanagementfacades.cancellation.data.OrderCancelRequestData} to create {@link de.hybris.platform.ordermanagementfacades.cancellation.data.OrderCancelRequestData}
	 */
	void createRequestOrderCancel(OrderCancelRequestData orderCancelRequestData);

	/**
	 * API to manually release void payment in waiting step.
	 *
	 * @param orderCode
	 * 		the {@link de.hybris.platform.core.model.order.OrderModel#CODE}
	 */
