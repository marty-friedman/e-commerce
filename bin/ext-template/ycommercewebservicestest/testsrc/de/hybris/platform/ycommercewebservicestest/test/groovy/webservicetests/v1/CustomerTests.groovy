...
class CustomerTests extends BaseWSTest {
	...
	def addToCardAndGetCookie(code, access_token = null) {
		...
		if (access_token != null) {
			...
			con = testUtil.getSecureConnection('/cart/entry', 'POST', 'JSON', HttpURLConnection.HTTP_OK, postBody)
		}
		def response = testUtil.verifiedJSONSlurper(con)
	...
	def createPaymentInfo() {
		...
		def postBody = "accountHolderName=Sven+Haiges&cardNumber=4111111111111111&cardType=visa&expiryMonth=01&expiryYear=2013&saved=true&defaultPaymentInfo=false&billingAddress.titleCode=mr&billingAddress.firstName=sven&billingAddress.lastName=haiges&billingAddress.line1=test1&billingAddress.line2=test2&billingAddress.postalCode=12345&billingAddress.town=somecity&billingAddress.country.isocode=US&billingAddress.region.isocode=US-NY"
	...
	def addPaymentInfo(cookieNoPath, access_token, defaultPaymentInfo = true, saved = true) {
		def postBody = "accountHolderName=Sven+Haiges&cardNumber=4111111111111111&cardType=visa&expiryMonth=01&expiryYear=2013&saved=$saved&defaultPaymentInfo=$defaultPaymentInfo&billingAddress.titleCode=mr&billingAddress.firstName=sven&billingAddress.lastName=haiges&billingAddress.line1=test1&billingAddress.line2=test2&billingAddress.postalCode=12345&billingAddress.town=somecity&billingAddress.country.isocode=US&billingAddress.region.isocode=US-NY"
	...
	void testUpdatePaymentAddress() {
		...
		/* when */
		def postBody = "titleCode=mr&firstName=ChangedFirstName&lastName=ChangedLastName&line1=ChangedLine1&line2=ChangedLine2&postalCode=44-100&town=ChangedTown&country.isocode=US&region.isocode=US-NY"
		...
		assert response.billingAddress.country.isocode == "US"
		assert response.billingAddress.region.isocode == "US-NY"
	}
	...
	void testUpdatePaymentAddressJSON() {
		...
		/* when */
		def postBody = "titleCode=ms&firstName=ChangedFirstName&lastName=ChangedLastName&line1=ChangedLine1&line2=ChangedLine2&postalCode=44-100&town=ChangedTown&country.isocode=US&region.isocode=US-NY"
	...
	void testPaymentInfosFlowJSON() {
		...
		def postBody = "accountHolderName=Sven+Haiges&cardNumber=4111111111111111&cardType=visa&expiryMonth=01&expiryYear=2013&saved=true&defaultPaymentInfo=true&billingAddress.titleCode=mr&billingAddress.firstName=sven&billingAddress.lastName=haiges&billingAddress.line1=test1&billingAddress.line2=test2&billingAddress.postalCode=12345&billingAddress.town=somecity&billingAddress.country.isocode=US&billingAddress.region.isocode=US-NY"
		def con = testUtil.getSecureConnection("/cart/paymentinfo", 'POST', 'JSON', HttpURLConnection.HTTP_OK, postBody, cookieNoPath, access_token)
		...
		postBody = "titleCode=mr&firstName=ChangedFirstName&lastName=ChangedLastName&line1=ChangedLine1&line2=ChangedLine2&postalCode=44-100&town=ChangedTown&country.isocode=US&region.isocode=US-NY"
		...
		assert response.paymentInfos[0].billingAddress.country.isocode == "US"
		assert response.paymentInfos[0].billingAddress.region.isocode == "US-NY"
