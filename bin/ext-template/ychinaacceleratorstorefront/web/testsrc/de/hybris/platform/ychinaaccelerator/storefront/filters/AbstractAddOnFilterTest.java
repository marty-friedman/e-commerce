 ...
 */
package de.hybris.platform.ychinaaccelerator.storefront.filters;

import de.hybris.bootstrap.annotations.UnitTest;
import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.ychinaaccelerator.storefront.filters.AcceleratorAddOnFilter.ExtensionAccessor;
...
public abstract class AbstractAddOnFilterTest
{
	...
	protected static final String STOREFRONT_NAME = "ychinaacceleratorstorefront";
	protected static final String ADDONTWO_NAME = "addontwo";

	protected static final String UI_FOLDER = "/webroot/_ui";
	...
	protected Map<String,String> preparedAddOnConfig()
	{
		final Map<String,String> expectedMap = new HashMap<String,String>();

		expectedMap.put(STOREFRONT_NAME + "/web" + getFolder() + "/addons/" + ADDONTWO_NAME, ADDONTWO_NAME + "/acceleratoraddon"
				+ getFolder());
		expectedMap.put(ADDONTWO_NAME + "/web" + getFolder() + "/addons/addonone", "addonone/acceleratoraddon" + getFolder());
