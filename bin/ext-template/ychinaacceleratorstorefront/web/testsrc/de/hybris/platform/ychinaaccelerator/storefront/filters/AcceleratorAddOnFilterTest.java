...
public class AcceleratorAddOnFilterTest
{
	...
	private static final String STOREFRONT_NAME = "ychinaacceleratorstorefront";
	...
	@Mock
	private de.hybris.platform.ychinaaccelerator.storefront.filters.AcceleratorAddOnFilter.ExtensionAccessor extensionAccessor;
	...
	public void testPlainResource() throws ServletException, IOException
	{
		...
		Mockito.verify(filter).copyFileInternalIfNeeded(
				"/some/otherdir/" + ADDONTWO + "/acceleratoraddon/webroot/_ui/some/special/resource.txt", remotePath);
	}
	...
	public void testTagResource() throws ServletException, IOException
	{
		...
		Mockito.verify(filter).copyFileInternalIfNeeded(
				"/some/otherdir/" + ADDONTWO + "/acceleratoraddon/webroot/WEB-INF/tags/some/special/resource.tag", //
