 ...
 */
package de.hybris.platform.ychinaaccelerator.storefront.interceptors;
...
import de.hybris.platform.ychinaaccelerator.storefront.util.CSRFHandlerInterceptor;
...
public class CSRFHandlerInterceptorTest extends ServicelayerTest
{
	...
	private static final String SESSION_CSRF_ATTRIBUTE = "de.hybris.platform.yacceleratorstorefront.util.CSRFTokenManager.tokenval";
