...
<script type="text/javascript" src="${commonResourcePath}/js/jquery-migrate-3.0.0.js"></script>
<%-- j query query 2.1.7 --%>
...
<%-- j carousel adjusted with lazyload for CNACC --%>
<script type="text/javascript" src="${commonResourcePath}/js/jquery.jcarousel-0.2.8-lazyload.min.js"></script>
<%-- j query templates --%>
...
<%-- BeautyTips  --%>
<script type="text/javascript" src="${commonResourcePath}/js/jquery.bgiframe-3.0.1.min.js"></script>
...
<%-- CHINAACC_START --%>
<script type="text/javascript" src="${commonResourcePath}/js/acc.tab.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/acc.mapstores_baidu.js"></script>
<%-- CHINAACC:COMMENT: jQuery plugin for lazy loading images (Mika Tuupola) --%>
<script type="text/javascript" src="${commonResourcePath}/js/jquery.lazyload-1.9.3.min.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/acc.lazyload.js"></script>
<%-- CHINAACC_END --%>
