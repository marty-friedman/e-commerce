...
<template:page pageTitle="${pageTitle}"  navg="false" schbox="false">
	...
	<div class="cartpage span-24">
		<div class="submitOrder">
					<div class="step3"><spring:theme code="order.submit.successfully" /></div>
                    <div class="submitOrder2">
                    	<p class="submitOrderTxt"><spring:theme code="order.submit.successful.congratulation" /></p>
                        <div class="submitOrder3">
                        	<div class="submitOrder4 clearfix">
                            	<div class="submitOrder4_left"><spring:theme code="order.submit.order.code" /><strong><spring:theme code="text.account.order.orderNumber" text="Order number is {0}" arguments="${orderData.code}"/></strong></div>
                                <div class="submitOrder4_right"><spring:theme code="order.submit.due.payment" /><strong><format:price priceData="${orderData.totalPrice}"/></strong></div>
                            </div>
                            <div class="submitOrder5 clearfix">
