...
<jsp:attribute name="pageScripts">
		...
		$(function(){
			...
			$('.payPop').css('top', top);
			$('.myOrderDetail2_r_pay').click(function(){
...
<jsp:body>
    ...
    <div class="payPop">
        ...
        <div class="payPopBtn clearfix">
        	<a href="${contextPath}/my-account/order/${orderData.code}"  class="payPopBtn_left"><spring:theme code="order.payment.successfully" /></a>
            <a href="${contextPath}/my-account/order/${orderData.code}" class="payPopBtn_right"><spring:theme code="order.payment.rencontre.problem" /></a>
        </div>	
    </div>
