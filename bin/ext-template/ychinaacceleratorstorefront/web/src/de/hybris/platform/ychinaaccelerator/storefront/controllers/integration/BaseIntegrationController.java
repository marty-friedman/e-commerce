 ...
 */
package de.hybris.platform.ychinaaccelerator.storefront.controllers.integration;
...
public class BaseIntegrationController  extends AbstractController
{
	...
	protected void initializeSiteFromRequest(final HttpServletRequest httpRequest)
	{
		...
		{
			LOG.warn("Cannot find CMSSite associated with current URL!");
			if (LOG.isDebugEnabled())
			{
				LOG.debug("Cannot find CMSSite associated with current URL in BaseIntegrationController.initializeSiteFromRequest!");
			}
		}
	}
