...
import de.hybris.platform.ychinaaccelerator.storefront.filters.btg.support.PkResolvingStrategy;
import de.hybris.platform.ychinaaccelerator.storefront.filters.btg.support.UrlParsingStrategy;
...
public abstract class AbstractParsingPkResolvingStrategy implements PkResolvingStrategy
{
	...
	public String resolvePrimaryKey(final HttpServletRequest request)
	{
		...
		if (!StringUtils.isBlank(key))
		{
			...
			{
				LOG.warn("Could not retrieve the category from request");
			}
		}
		return result;
	}
