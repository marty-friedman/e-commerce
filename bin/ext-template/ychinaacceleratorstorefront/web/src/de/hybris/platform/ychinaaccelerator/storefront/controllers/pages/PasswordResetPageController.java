...
/**
 * Controller for the forgotten pwd pages. Supports requesting a password reset email as well as changing the
...
public class PasswordResetPageController extends AbstractPageController
{
	...
	public String getPasswordRequest(final Model model) throws CMSItemNotFoundException
	{
		...
		return ControllerConstants.Views.Fragments.Password.PdResetRequestPopup;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		else
		{
			...
			{
				LOG.warn("Email does not exist in the database.");
			}
			return ControllerConstants.Views.Fragments.Password.ForgotPdValidationMessage;
		}
	}
	...
	public String getExternalPasswordRequest(final Model model) throws CMSItemNotFoundException
	{
		...
		return ControllerConstants.Views.Pages.Password.PdResetRequest;
	}
	...
	public String getExternalPasswordRequestConf(final Model model) throws CMSItemNotFoundException
	{
		...
		setUpMetaDataForContentPage(model, getContentPageForLabelOrId(null));
		model.addAttribute(WebConstants.BREADCRUMBS_KEY, resourceBreadcrumbBuilder.getBreadcrumbs("forgottenPwd.title"));
		return ControllerConstants.Views.Pages.Password.PdResetRequestConfirmation;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		return ControllerConstants.Views.Pages.Password.PdResetChangePage;
	}
