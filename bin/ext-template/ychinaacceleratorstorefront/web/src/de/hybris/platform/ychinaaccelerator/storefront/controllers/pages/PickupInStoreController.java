...
import de.hybris.platform.ychinaaccelerator.storefront.security.cookie.CustomerLocationCookieGenerator;
...
public class PickupInStoreController extends AbstractSearchPageController
{
	...
	public String getPointOfServiceForStorePickupSubmit(@PathVariable("productCode") final String encodedProductCode,
			...
			@RequestParam(value = "qty", defaultValue = "0") final Long qty, final HttpServletResponse response, final Model model)
	{
		...
		return getPointOfServiceForStorePickup(decodeWithScheme(encodedProductCode, UTF_8), locationQuery, geoPoint, page, showMode, sortCode, cartPage,
	...
	public String getPointOfServiceForStorePickupClick(@PathVariable("productCode") final String encodedProductCode,
			@RequestParam(value = "page", defaultValue = "0") final int page,
			@RequestParam(value = "show", defaultValue = "Page") final AbstractSearchPageController.ShowMode showMode,
			@RequestParam(value = "sort", required = false) final String sortCode,
			...
			final HttpServletResponse response, final Model model)
	{
		...
		return getPointOfServiceForStorePickup(decodeWithScheme(encodedProductCode, UTF_8), location, geoPoint, page, showMode, sortCode, cartPage, entryNumber,
			...
			final BindingResult bindingErrors)
	{
		...
		catch (final CommerceCartModificationException ex)
		{
			...
			LOG.warn("Couldn't add product of code to cart.");
		}
