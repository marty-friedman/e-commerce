 ...
 */
package de.hybris.platform.ychinaaccelerator.storefront.interceptors.beforeview;
...
import de.hybris.platform.ychinaaccelerator.storefront.interceptors.BeforeViewHandler;
import de.hybris.platform.ychinaaccelerator.storefront.util.CSRFTokenManager;
...
public class UiThemeResourceBeforeViewHandler implements BeforeViewHandler
{
	...
	public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView)
	{
		...
		final List<String> dependantAddOns = requiredAddOnsNameProvider.getAddOns(request.getServletContext().getServletContextName());
