...
public class ProductsController extends BaseController
{
	...
	@ResponseBody
	@ApiOperation(value = "Get a list of products and additional data", notes = "Returns a list of products and additional data, such as available facets, "
	...
	@ApiOperation(value = "Get a header with total number of products", notes = "In the response header, the \"x-total-count\" indicates the total number of products satisfying a query.")
	@ApiBaseSiteIdParam
	...
	@ResponseBody
	@ApiOperation(value = "Get a product's stock level for a store", notes = "Returns a product's stock level for a particular store (in other words, for a particular point of sale).")
	...
	@ResponseBody
	@ApiOperation(value = "Get a product's stock level", notes = "Returns a product's stock levels sorted by distance from the specified location, which is provided "
	...
	@ApiOperation(value = "Get header with a total number of product's stock levels", notes = "In the response header, the \"x-total-count\" indicates the total number of a "
	...
	@ResponseBody
	@ApiOperation(value = "Get products added to the express update feed", notes = "Returns products added to the express update feed. Returns only elements "
