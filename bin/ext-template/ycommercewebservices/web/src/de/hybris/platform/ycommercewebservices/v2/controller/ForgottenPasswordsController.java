...
public class ForgottenPasswordsController extends BaseController
{
	...
	@ApiOperation(value = "Generates a token to restore a customer's forgotten password.", notes = "Generates a token to restore a customer's forgotten password.", authorizations =
