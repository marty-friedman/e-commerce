...
/**
 * This is the extension manager of the Yhacext extension.
 */
public class YhacextManager extends GeneratedYhacextManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YhacextManager.class.getName());
	 ...
	 */
	public static YhacextManager getInstance()
	{
		return (YhacextManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YhacextConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YhacextManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YhacextManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YhacextManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YhacextManager called, current tenant: " + getTenant().getTenantID());
		}
	}
