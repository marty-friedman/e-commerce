...
public class GenerateEmailWithAttachmentAction extends AbstractSimpleDecisionAction
{
		...
		if (contentCatalogVersion != null)
		{
			...
			if (emailPageModel != null)
			{
				...
				if (emailMessageModel != null)
				{
					...
					{
						saveReturnLabelAndReturnFormAttachments(returnLabelAttachmentModel, returnFormAttachmentModel,
								emailMessageModel, businessProcessModel);
	...
	{
		Assert.isTrue(ReturnRequestModel.RETURNLABEL.equals(propertyName) || ReturnRequestModel.RETURNFORM.equals(propertyName),
