...
import ywebservicespackage.dto.UsersPageWsDTO;
import ywebservicespackage.facades.SampleFacades;
import ywebservicespackage.initializer.TestBean;
...
public class SampleController
{
	...
	public UsersListWsDTO getUsers(
			@ApiParam(value = "Response object configuration") @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
	...
	/**
	 * Request handler for paginated response. Retrieves user from userService and maps result to UsersPageWsDTO Mapping
	 * is done according to configuration in WEB-INF/config/field-mapping.xml Sample url's:
	 * <ul>
	 * <li>http://localhost:9001/ywebservices/sample/usersPaged
	 * <li>http://localhost:9001/ywebservices/sample/usersPaged?currentPage=1
	 * <li>http://localhost:9001/ywebservices/sample/usersPaged?currentPage=0?pageSize=1
	 * </ul>
	 */
	...
	public TestBean getTestBeanText()
	{
		return testBean;
	}
