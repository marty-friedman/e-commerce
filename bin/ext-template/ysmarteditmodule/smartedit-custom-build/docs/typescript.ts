...
<em>ysmarteditmodule/web/features/ysmarteditmoduleContainer/ysmarteditmodulecontainer.ts</em>
```ts
import {IFeatureService} from 'smarteditcommons';
angular.module('ysmarteditmoduleContainer', ['smarteditServicesModule'])
...
SmartEdit uses Webpack, a module bundler, to bundle the application. The TypeScript source code is transpiled into JavaScript and the existing JavaScript code (ES5) is bundled as is. The following files are the Webpack configuration for the ysmarteditmodule:
- <em>ysmarteditmodule/smartedit-custom-build/generated/webpack.[dev/prod/karma].smartedit.config.js</em>
- <em>ysmarteditmodule/smartedit-custom-build/generated/webpack.[dev/prod/karma].smarteditContainer.config</em>

The 'ysmarteditmodule' layer of ysmarteditmodule is a bundle of ysmarteditmodule and ysmarteditmodulecommons.
The 'ysmarteditmoduleContainer' layer of ysmarteditmodule is a bundle of ysmarteditmoduleContainer and ysmarteditmodulecommons.
