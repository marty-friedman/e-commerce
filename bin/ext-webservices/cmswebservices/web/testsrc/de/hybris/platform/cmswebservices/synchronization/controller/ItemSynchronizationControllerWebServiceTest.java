...
public class ItemSynchronizationControllerWebServiceTest extends ApiBaseIntegrationTest
{
	...
	public void setup()
	{
		...
		contentPageModelMother.DefaultHomePage(stagedCatalogVersionModel);
	...
	public void shouldGetPageSyncronizationStatus() throws Exception
	{
		...
		final Response response = getCmsManagerWsSecuredRequestBuilder() //
				...
				.path("pages") //
				.path(ContentPageModelMother.UID_DEFAULT_HOMEPAGE)
				.build() //
	...
	public void shouldCreateItemSynchronizationForPageSlotAndParagraph() throws Exception
	{
		...
		final ItemSynchronizationWsDTO page = getItemSynchronizationWsDTO(ContentPageModelMother.UID_DEFAULT_HOMEPAGE, AbstractPageModel._TYPECODE);
