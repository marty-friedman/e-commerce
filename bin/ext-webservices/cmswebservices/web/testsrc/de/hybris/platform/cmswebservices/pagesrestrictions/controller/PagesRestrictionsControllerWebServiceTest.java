...
public class PagesRestrictionsControllerWebServiceTest extends ApiBaseIntegrationTest
{
	...
	public void setup()
	{
		...
		contentPageModelMother.somePage(catalogVersion, OTHER_PAGE, "other-page-title");
	...
	public void shouldSuccessfullyPutPageRestrictions() throws Exception
	{
		...
		final Response responseForPutOnHomepage = getCmsManagerWsSecuredRequestBuilder() //
				.path(replaceUriVariablesWithDefaults(PAGE_RESTRICTION_UPDATE_ENDPOINT, collectionInstanceMap))
				.build() //
				.accept(MediaType.APPLICATION_JSON) //
	...
	public void shouldFailPutPageRestrictions_AmbiguousPageId() throws Exception
	{
		...
		final HashMap<String, String> collectionInstanceMap = new HashMap<>();
		collectionInstanceMap.put(CmswebservicesConstants.URI_PAGE_ID, ContentPageModelMother.UID_HOMEPAGE);
		final PageRestrictionListData entity = createAnEntityForRestrictionOnPage(
				ContentPageModelMother.UID_SEARCHPAGE, CMSTimeRestrictionModelMother.UID_TOMORROW);
		final Response responseForPutOnHomepage = getCmsManagerWsSecuredRequestBuilder() //
				.path(replaceUriVariablesWithDefaults(PAGE_RESTRICTION_UPDATE_ENDPOINT, collectionInstanceMap))
				.build() //
				.accept(MediaType.APPLICATION_JSON) //
	...
	public void shouldFailPutPageRestrictions_InvalidPageId()
	{
		...
		final Response responseForPutOnHomepage = getCmsManagerWsSecuredRequestBuilder() //
				.path(replaceUriVariablesWithDefaults(PAGE_RESTRICTION_UPDATE_ENDPOINT,
						params))
				.build() //
				.accept(MediaType.APPLICATION_JSON) //
				.put(Entity.entity(entity, MediaType.APPLICATION_JSON));
	...
	{
		final AbstractPageModel someDeletedPage = contentPageModelMother
				.somePage(catalogVersion, "some-deleted-page", "Some Deleted Page", CmsPageStatus.DELETED);
