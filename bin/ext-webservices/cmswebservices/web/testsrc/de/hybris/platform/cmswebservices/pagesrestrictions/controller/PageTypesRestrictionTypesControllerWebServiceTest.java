...
public class PageTypesRestrictionTypesControllerWebServiceTest extends ApiBaseIntegrationTest
{
	...
	public void shouldGetPageTypesRestrictionTypes()
	{
		final Response response = getCmsManagerWsSecuredRequestBuilder() //
				.path(replaceUriVariablesWithDefaults(PAGE_TYPE_RESTRICTION_TYPE_ENDPOINT,
						new HashMap<>()))
				.build() //
		...
		final PageTypeRestrictionTypeListData entity = response
				.readEntity(PageTypeRestrictionTypeListData.class);
