...
public class CMSItemControllerForMultiCountryWebServiceTest extends ApiBaseIntegrationTest
{
	...
	public void shouldOverrideExistingPrimaryContentPageAfterCloning()
	{
		...
		final ContentPageModel originalContentPageModel = contentPageModelMother.DefaultHomePage(originalCatalogVersionModel);

		final CatalogVersionModel targetCatalogVersionModel = catalogVersionModelMother.createCarEuropeStagedCatalogVersionModel();
		final ContentPageModel targetContentPageModel = contentPageModelMother.DefaultHomePage(targetCatalogVersionModel);
		final String targetContentPageUid = targetContentPageModel.getUid();

		final PageTemplateModel pageTemplate = pageTemplateModelMother.HomePage_Template(originalCatalogVersionModel);
	...
	public void shouldOverrideExistingPrimaryProductPageAfterCloning()
	{
		...
		final CatalogVersionModel originalCatalogVersionModel = catalogVersionModelMother
				.createCarGlobalOnlineCatalogVersionModel();
		final ProductPageModel originalProductPageModel = productPageModelMother.DefaultProductPage(originalCatalogVersionModel);

		final CatalogVersionModel targetCatalogVersionModel = catalogVersionModelMother.createCarEuropeStagedCatalogVersionModel();
		final ProductPageModel targetProductPageModel = productPageModelMother.DefaultProductPage(targetCatalogVersionModel);
