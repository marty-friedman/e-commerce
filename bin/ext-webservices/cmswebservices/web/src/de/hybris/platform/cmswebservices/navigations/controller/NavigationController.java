...
public class NavigationController
{
	...
	public NavigationNodeData findNavigationNodeById(
			@ApiParam(value = "The navigation node's unique identifier", required = true) @PathVariable("uid") final String uid) throws CMSItemNotFoundException
	{
	...
	@ResponseBody
	@ApiOperation(value = "Update navigation node by id", notes = "Updates the navigation node for a given navigation node uid")
	@ApiResponses({
	...
	public NavigationNodeData updateNavigationNodeById(
			...
			@ApiParam(value = "The navigation node data", required = true) @RequestBody final NavigationNodeData navigationNode) throws CMSItemNotFoundException
	{
		try
		{
	...
	@ApiOperation(value = "Delete navigation node by id", notes = "Deletes the navigation node.")
	@ApiResponses({

			@ApiResponse(code = 400, message = "When the Navigation Node has not been found (CMSItemNotFoundException).")
	})
	public void deleteNavigationNodeById(
			@ApiParam(value = "The navigation node's uid.", required = true) @PathVariable("uid") final String uid) throws CMSItemNotFoundException
	{
