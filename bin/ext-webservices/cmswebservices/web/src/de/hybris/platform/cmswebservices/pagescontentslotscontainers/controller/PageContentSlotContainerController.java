...
public class PageContentSlotContainerController
{
          ...
          @ApiParam(value = "Identifier of the page", required = true) @RequestParam("pageId") final String pageId)
    {
        ...
        try
        {
            final List<de.hybris.platform.cmsfacades.data.PageContentSlotContainerData> pageSlotContainerList =
                    getPageContentSlotContainerFacade().getPageContentSlotContainersByPageId(pageId);
