...
public class I18nControllerWebServiceTest extends ServicelayerTest
{
	...
	private static final String URI_EN_JAVA_LANG_TAG = "/v1/i18n/translations/en_US";
	private static final String URI_EN_BCP47_LANG_TAG = "/v1/i18n/translations/en-US";
	...
	@Test
	public void shouldGetEnglishTranslationsForJavaLangTag()
	{
		final Response response = wsRequestBuilder//
				.path(URI_EN_JAVA_LANG_TAG)//
				.build()//
	...
	@Test
	public void shouldGetEnglishTranslationsForBcp47LangTag()
	{
		final Response response = wsRequestBuilder//
				.path(URI_EN_BCP47_LANG_TAG)//
				.build()//
				.accept(MediaType.APPLICATION_JSON)//
				.get();
