...
public class DefaultSmarteditI18nFacadeTest
{
	...
	private static final Locale COLUMBIA_SPANISH = Locale.forLanguageTag("es-CO");
	...
	public void shouldGetTranslations_By_Language_Tag_With_Special_Character()
	{
		...
		// WHEN
		final Map<String, String> translations = smarteditI18nFacade.getTranslationMap(COLUMBIA_SPANISH.toLanguageTag());
