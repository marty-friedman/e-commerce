 ...
 * @deprecated Since version 6.5. Use {@link de.hybris.platform.cmsfacades.types.ComponentTypeFacade} instead.
 */
@Deprecated
...
public interface StructureFacade
{
	 ...
	 * @return the component type structures or empty array when the code provided does not match any existing types
	 *            
	 */
