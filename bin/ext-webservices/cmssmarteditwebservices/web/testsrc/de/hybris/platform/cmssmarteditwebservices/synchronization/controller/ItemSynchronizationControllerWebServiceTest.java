...
public class ItemSynchronizationControllerWebServiceTest extends ApiBaseIntegrationTest
{
	...
	public void setup()
	{
		...
		final ContentSlotForPageModel contentSlotForPageModel = contentSlotForPageModelMother.HeaderHomepage_ParagraphOnly(
				stagedCatalogVersionModel);
	...
	public void shouldGetPageSyncronizationStatus() throws Exception
	{
		...
		assertThat(entity.getDependentItemTypesOutOfSync(), contains(hasProperty("itemType", is(ContentSlotModel._TYPECODE)),
