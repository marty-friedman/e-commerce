...
public class CustomizationControllerTest extends BaseControllerTest
{
	...
	public void setUp() throws Exception
	{
		...
		controller = new CustomizationController(cxCustomizationFacade, new CustomizationDataValidator());
		controller.setWebPaginationUtils(webPaginationUtils);

		vcontroller = new VariationController(cxVariationFacade, new VariationDataValidator());
