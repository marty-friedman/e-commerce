 ...
 */
package com.sap.hybris.sec.sso.constants;

/**
 * Global class for all Samlcommercesecsso constants. You can add global constants for your extension into this class.
 */
public final class SamlcommercesecssoConstants extends GeneratedSamlcommercesecssoConstants
{
	public static final String EXTENSIONNAME = "samlcommercesecsso";

	private SamlcommercesecssoConstants()
	{
	...
	public static final String PLATFORM_LOGO_CODE = "samlcommercesecssoPlatformLogo";
