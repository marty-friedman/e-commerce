...
@JsonPropertyOrder(
{ "metadata", "mixins", "title", "firstName", "middleName", "lastName", "contactEmail", "contactPhone", "company",
		"preferredLanguage", "preferredCurrency", "preferredSite", "isDelete" })
public class Customer
{
	...
	public Customer withMetadata(final Metadata metadata)
	{
		this.metadata = metadata;
		return this;
	}
	 ...
	 */
	@JsonProperty("mixins")
	public void setMixins(final Mixins mixins)
	{
		this.mixins = mixins;
	}

	public Customer withMixins(final Mixins mixins)
	{
		this.mixins = mixins;
		return this;
	}
