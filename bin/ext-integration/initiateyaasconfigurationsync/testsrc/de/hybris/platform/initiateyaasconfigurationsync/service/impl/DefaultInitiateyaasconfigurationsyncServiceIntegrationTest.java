 ...
 */
@IntegrationTest
public class DefaultInitiateyaasconfigurationsyncServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	private InitiateyaasconfigurationsyncService initiateyaasconfigurationsyncService;
	@Resource
	...
	{
		// given
		final String logoCode = "initiateyaasconfigurationsyncPlatformLogo";

		// when
		final String logoUrl = initiateyaasconfigurationsyncService.getHybrisLogoUrl(logoCode);
