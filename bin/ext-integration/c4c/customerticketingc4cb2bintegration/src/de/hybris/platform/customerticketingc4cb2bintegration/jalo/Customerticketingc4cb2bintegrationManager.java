 ...
 */
package de.hybris.platform.customerticketingc4cb2bintegration.jalo;
...
import de.hybris.platform.customerticketingc4cb2bintegration.constants.Customerticketingc4cb2bintegrationConstants;



/**
 * This is the extension manager of the Customerticketingc4cb2bintegration extension.
 */
public class Customerticketingc4cb2bintegrationManager extends GeneratedCustomerticketingc4cb2bintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Customerticketingc4cb2bintegrationManager.class.getName());
	 ...
	 */
	public static Customerticketingc4cb2bintegrationManager getInstance()
	{
		return (Customerticketingc4cb2bintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Customerticketingc4cb2bintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Customerticketingc4cb2bintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Customerticketingc4cb2bintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Customerticketingc4cb2bintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Customerticketingc4cb2bintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
