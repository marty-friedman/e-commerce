 ...
 */
package de.hybris.platform.customerticketingc4cintegration.jalo;
...
/**
 * This is the extension manager of the Customerticketingc4cintegration extension.
 */
public class Customerticketingc4cintegrationManager extends GeneratedCustomerticketingc4cintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Customerticketingc4cintegrationManager.class.getName());
	 ...
	 */
	public static Customerticketingc4cintegrationManager getInstance()
	{
		return (Customerticketingc4cintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Customerticketingc4cintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Customerticketingc4cintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Customerticketingc4cintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Customerticketingc4cintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Customerticketingc4cintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
