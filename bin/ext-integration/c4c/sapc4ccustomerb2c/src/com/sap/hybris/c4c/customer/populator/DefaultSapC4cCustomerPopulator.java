...
public class DefaultSapC4cCustomerPopulator implements Populator<CustomerModel, C4CCustomerData>
{
	...
	public void populate(final CustomerModel customerModel, final C4CCustomerData customerData) throws ConversionException
	{
		...
		customerData.setCategoryCode(
				getConfigurationProperty(Sapc4ccustomerb2cConstants.C4C_CUSTOMER_CATEGORY_CODE));
		...
		customerData.setGender(
				getConfigurationProperty(Sapc4ccustomerb2cConstants.C4C_CUSTOMER_GENDER_CODE));
		...
		customerData.setBlockedIndicator(
				getConfigurationProperty(Sapc4ccustomerb2cConstants.C4C_CUSTOMER_BLOCKED_INDICATOR));
		customerData.setDeletedIndicator(
				getConfigurationProperty(Sapc4ccustomerb2cConstants.C4C_CUSTOMER_DELETED_INDICATOR));
		customerData.setReleasedIndicator(
				getConfigurationProperty(Sapc4ccustomerb2cConstants.C4C_CUSTOMER_RELEASED_INDICATOR));
	...
	protected C4CHeaderData populateHeaderData()
	{
		...
		header.setUuid(uuid);
		header.setSenderParty(
				getConfigurationProperty(Sapc4ccustomerb2cConstants.C4C_CUSTOMER_SENDER_PARTY));
		header.setRecipientParty(
				getConfigurationProperty(Sapc4ccustomerb2cConstants.C4C_CUSTOMER_RECIPIENT_PARTY));
