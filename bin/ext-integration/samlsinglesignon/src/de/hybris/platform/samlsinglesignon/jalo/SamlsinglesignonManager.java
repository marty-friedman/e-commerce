...
/**
 * This is the extension manager of the Samlsinglesignon extension.
 */
public class SamlsinglesignonManager extends GeneratedSamlsinglesignonManager
{
	...
	{
		return (SamlsinglesignonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SamlsinglesignonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SamlsinglesignonManager() // NOPMD 
	{
