...
{
	public static final String MY_SAML_USER_GROUP = "mySamlUserGroup";
	...
	public void shouldReturnNullForInexistentSamlUserGroup()
	{
		...
		// then
		Assertions.assertThat(samlUserGroup.isPresent()).isFalse();
	}
	...
	public void shouldFindExistingSamlUserGroup()
	{
		...
		// then
		Assertions.assertThat(foundSamlUserGroup.isPresent()).isTrue();
		Assertions.assertThat(foundSamlUserGroup.get()).isEqualTo(samlUserGroupModel);
	}
}
