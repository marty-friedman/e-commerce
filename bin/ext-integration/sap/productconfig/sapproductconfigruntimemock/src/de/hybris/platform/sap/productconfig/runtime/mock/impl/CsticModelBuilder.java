...
public class CsticModelBuilder
{
	...
	/**
	 * creates typical default values assuming cstic should behave like a simple input field<br>
	 * <b> will overwrite any other data set to the cstic beforeahnd!</b>
	 *
	 * @return
	 */
	public CsticModelBuilder withDefaults()
	{
		withNoValuesAndOptions();

		// header
		withInstance("1", "TEST INSTANCE");
		withName("TEST CSTIC", "TestCstic");

		// value / ui type and state
		stringType();
		simpleInput();
		withDefaultUIState();

		// some special stuff
		cstic.setLongText(null);
		cstic.setEntryFieldMask(null);
		cstic.setPlaceholder(null);
		cstic.setMessages(null);
	...
	public CsticModelBuilder withOptions(final CsticValueModel... options)
	{
