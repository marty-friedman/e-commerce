...
public class CharacteristicPopulatorTest
{
	...
	@Mock
	private Converter<CPSValue, CsticValueModel> mockedValueConverter;
	@Mock
	private Converter<CPSPossibleValue, CsticValueModel> mockedPossibleValueConverter;
	@Mock
	...
	public void initialize()
	{
		...
		classUnderTest = Mockito.spy(new CharacteristicPopulator());
		...
		Mockito.when(mockedValueConverter.convert(Mockito.any())).thenAnswer(valueModelAnswer);
		classUnderTest.setPossibleValueConverter(mockedPossibleValueConverter);
		Mockito.when(mockedPossibleValueConverter.convert(Mockito.any())).thenAnswer(valueModelAnswer);
	...
	{
		classUnderTest.populateValues(source, target);
	...
	public void testPopulateValuesCheckOrder()
	{
		...
		Mockito.when(mockedValueConverter.convert(Mockito.any())).thenAnswer(valueModelAnswerUsingInput);

		classUnderTest.populateValues(multiSource, target);
	...
	{
		classUnderTest.populatePossibleValues(source, target);
	...
	{
		classUnderTest.populatePossibleValues(sourceIntervals, target);
