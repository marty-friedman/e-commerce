...
public interface ConfigurationMasterDataService
{
	...
	/**
	 * Gets characteristic ids for group. In case we are requesting the characteristics for class nodes, all characteristic
	 * assigned to the class node will be returned as the class node does not carry any group besides the 'general' dummy
	 * group
	 *
	 * @param kbId
	 *           id of the knowledgebase
