...
public interface RequestErrorHandler
{
	 ...
	 */
	CPSExternalConfiguration processGetExternalConfigurationError(HttpException ex) throws ConfigurationEngineException;
	 ...
	 *
	 */
	void processConfigurationRuntimeException(RuntimeException e) throws ConfigurationEngineException;
