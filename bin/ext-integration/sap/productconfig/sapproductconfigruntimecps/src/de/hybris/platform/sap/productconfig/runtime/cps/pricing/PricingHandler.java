...
public interface PricingHandler
{
	 ...
	 */
	PriceSummaryModel getPriceSummary(String configId) throws PricingEngineException;
	 ...
	 * @throws PricingEngineException
	 */
	void fillValuePrices(final String kbId, final PriceValueUpdateModel updateModel) throws PricingEngineException;
	 ...
	 * @throws PricingEngineException
	 */
	void fillValuePrices(final String kbId, final CsticModel cstic) throws PricingEngineException;
