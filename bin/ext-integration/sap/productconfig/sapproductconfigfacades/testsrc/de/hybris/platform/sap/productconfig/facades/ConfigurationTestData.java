...
public class ConfigurationTestData
{
			...
			final List<CsticGroupModel> csticGroups)
	{
		...
		rootInstance.addCstic(createSTRCsticWithValue("CSTIC_1.4", "defaultValue", CsticValueModel.AUTHOR_USER,
	...
	protected static void createGroup2WithCsticAndAssignedValues(final InstanceModel rootInstance,
			final List<CsticGroupModel> csticGroups)
	{
		rootInstance.addCstic(createSTRCsticWithValue("CSTIC_2.1", "defaultValue", CsticValueModel.AUTHOR_USER,
				AUTHOR_EXTERNAL_DEFAULT));
