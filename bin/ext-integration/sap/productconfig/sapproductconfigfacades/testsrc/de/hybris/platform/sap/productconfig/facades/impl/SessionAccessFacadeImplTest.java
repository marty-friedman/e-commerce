...
public class SessionAccessFacadeImplTest
{
	...
	public void testConfigIdForCartEntry()
	{
		...
		Mockito.when(sessionAccessService.getConfigIdForCartEntry(cartEntryKey)).thenReturn(configId);
	...
	{
		{
			...
			classUnderTest.setCartEntryForProduct(productKey, cartEntryKey);
	...
	public void testRemoveConfigIdForCartEntry()
	{
		...
		Mockito.verify(sessionAccessService, Mockito.times(1)).removeConfigIdForCartEntry((cartEntryKey));
