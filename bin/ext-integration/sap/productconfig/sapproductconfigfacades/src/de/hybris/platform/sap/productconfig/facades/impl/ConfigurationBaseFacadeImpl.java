...
public class ConfigurationBaseFacadeImpl
{
	...
	protected void populateConfigDataFromModel(final ConfigurationData configData, final ConfigModel configModel)
	{
		...
		mapMessagesFromModelToData(configData, configModel);

	}

	protected void mapMessagesFromModelToData(final ConfigurationData configData, final ConfigModel configModel)
	{
	...
	protected void mapMessagesFromModelToData(final CsticData cstciData, final CsticModel csticModel)
	{
			...
			final Map<String, ClassificationSystemCPQAttributesContainer> nameMap)
	{
		...
		for (final CsticModel model : csticModelList)
		{
			...
			mapMessagesFromModelToData(csticData, model);
	 ...
	 *           for accessing the user session
	 */
	@Required
