 ...
 * can be used to show a configuration summary within the cart or order, without the need to instantiate the wheole
 * configuration, or eben to be aware of the configuration at all.
 */
public class ConfigurationOrderEntryProductInfoModelPopulator implements
		Populator<ConfigModel, List<AbstractOrderEntryProductInfoModel>>
{
			...
			final CsticModel csticModel, final Map<String, ClassificationSystemCPQAttributesContainer> nameMap)
	{
		...
		configInfoInline.setCpqCharacteristicAssignedValues(generateConfigInfoInline(assignedValues, csticModel, cpqAttributes,
