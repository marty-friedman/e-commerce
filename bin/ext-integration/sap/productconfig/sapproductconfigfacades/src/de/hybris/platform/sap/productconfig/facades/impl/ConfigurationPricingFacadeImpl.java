...
public class ConfigurationPricingFacadeImpl implements ConfigurationPricingFacade
{
	...
	public List<PriceValueUpdateData> getValuePrices(final List<String> csticUiKeys, final String configId)
	{
		...
		getPricingService().fillValuePrices(updateModels, configModel.getKbId());
	...
	public List<PriceValueUpdateData> getDeltaPrices(final List<String> csticUiKeys, final String configId)
	{
		return getValuePrices(csticUiKeys, configId);
	}
