...
public class ProductconfigConditionsEditorViewModel extends ConditionsEditorViewModel
{
			...
			final Collection<ParameterModel> treeNodeParameters)
	{
		...
		if (valueParameterUpdateRequired)
		{
			...
			addCustomAttributeToParameter(csticValueParameter,
					SapproductconfigrulesbackofficeConstants.REFERENCE_SEARCH_CONDITION_PRODUCT, product);
			if (product == null)
			{
				addCustomAttributeToParameter(csticValueParameter,
						SapproductconfigrulesbackofficeConstants.REFERENCE_SEARCH_CONDITION_CSTIC, null);
			}
		}
	}
