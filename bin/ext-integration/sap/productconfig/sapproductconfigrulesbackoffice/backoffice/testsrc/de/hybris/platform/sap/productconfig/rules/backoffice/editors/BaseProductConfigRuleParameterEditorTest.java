...
public class BaseProductConfigRuleParameterEditorTest
{
	...
	public void setUp()
	{
		...
		parameters.put(SapproductconfigrulesbackofficeConstants.REFERENCE_SEARCH_CONDITION_PRODUCT, productModel);
			...
			final int numberOfValues)
	{
		...
		final List<ValueParameter> valueList = new ArrayList<ValueParameter>();
