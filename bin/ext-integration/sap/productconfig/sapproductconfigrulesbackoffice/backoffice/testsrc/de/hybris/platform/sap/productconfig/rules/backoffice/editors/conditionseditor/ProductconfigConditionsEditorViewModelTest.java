...
public class ProductconfigConditionsEditorViewModelTest
{
	...
	public void setUp()
	{
		...
		treeNodeParameters = new ArrayList<ParameterModel>();
	...
	public void testAdjustCsticValueParameterMasterParameterProduct()
	{
		...
		assertEquals("MASTER_PRODUCT_CODE", ((ProductModel) attribute).getCode());
	}
	...
	public void testAdjustCsticValueParameterMasterParameterCstic()
	{
		...
		assertNotNull(attribute);
		assertEquals(PRODUCT_CODE, ((ProductModel) attribute).getCode());
	...
	public void testClearDependentParameterValuesForParameterProduct()
	{
		...
		final TreeNodeModel<ConditionModel> treeNode = new TreeNodeModel<ConditionModel>();
