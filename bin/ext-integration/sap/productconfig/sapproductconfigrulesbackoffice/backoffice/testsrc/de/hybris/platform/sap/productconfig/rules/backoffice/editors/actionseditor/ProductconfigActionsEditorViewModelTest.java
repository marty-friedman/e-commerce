...
public class ProductconfigActionsEditorViewModelTest
{
	...
	private ProductconfigActionsEditorViewModel classUnderTest;
	...
	public void setUp()
	{
		classUnderTest = new ProductconfigActionsEditorViewModel();
	...
	public void testClearDependentParameterValuesForParameterCstic()
	{
		...
		final TreeNodeModel<ActionModel> treeNode = new TreeNodeModel<ActionModel>();
	...
	{
		final Map<String, ParameterModel> parameterMap = new HashMap<String, ParameterModel>();
	...
	private ActionModel createActionModel()
	{
		...
		final Map<String, ParameterModel> parameters = new HashMap<String, ParameterModel>();
