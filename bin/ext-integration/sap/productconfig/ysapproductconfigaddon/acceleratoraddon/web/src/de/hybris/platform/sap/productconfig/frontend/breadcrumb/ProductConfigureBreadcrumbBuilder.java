...
public class ProductConfigureBreadcrumbBuilder extends ProductBreadcrumbBuilder
{
	...
	/**
	 * Builds the Breadcrumps when the configuration page is accessed from the cart.
	 *
	 * @param productCode
	...
	/**
	 * Builds the Breadcrumps for the OverviewPage. The exact structure depends on the context in which the overview page
	 * is displayed.
	 *
	 * @param productCode
	...
	protected List<Breadcrumb> getOverviewBreadcrumbsForConfigFromCart(final String productCode, final Integer cartEntryNumber)
	{
		...
		final Breadcrumb last = new Breadcrumb(getConfigFromCartURL(cartEntryNumber), getOverviewLinkText(), LAST_LINK_CLASS);
		breadcrumbs.add(last);
	...
	public List<Breadcrumb> getBreadcrumbsForConfigFromCart(final String productCode, final Integer cartEntryNumber)
	{
		...
		final Breadcrumb last = new Breadcrumb(getConfigFromCartURL(cartEntryNumber), getCurrentCartEntryConfigText(productCode),
				LAST_LINK_CLASS);
		breadcrumbs.add(last);
		return breadcrumbs;
	}

	protected String getConfigFromCartURL(final Integer cartEntryNumber)
	{
	...
	/**
	 * Builds the Breadcrumps when the configuration overview page is accessed in context of a product variant.
	 *
	 * @param baseProduct
