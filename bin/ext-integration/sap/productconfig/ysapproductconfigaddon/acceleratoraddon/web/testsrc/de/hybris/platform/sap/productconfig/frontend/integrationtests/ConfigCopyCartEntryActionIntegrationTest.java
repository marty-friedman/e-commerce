...
public class ConfigCopyCartEntryActionIntegrationTest extends CPQFacadeLayerTest
{
	...
	public void setUp() throws Exception
	{
		...
		cpqCopyCartActionHandler.setSessionAccessFacade(cpqSessionAccessFacade);
	...
	public void testCopyAction() throws CommerceCartModificationException, CartEntryActionException
	{
		...
		assertFalse("Both cart items have same config ID, copy did not create new config!",
				configFirstItem.getConfigId().equals(configSecondItem.getConfigId()));
	...
	protected ConfigurationData buildFromEntry(final OrderEntryData entry)
	{
		...
		final String configId = cpqSessionAccessFacade.getConfigIdForCartEntry(entry.getItemPK());
