...
public class AbstractProductConfigControllerBaseTest
{
	...
	public AbstractProductConfigControllerBaseTest()
	{
		super();
	...
	protected UiStatus createUiStatus(final String configId)
	{
	...
	protected void initializeFirstCall() throws Exception
	{
		...
		given(configFacade.getConfiguration(any(ProductData.class))).willReturn(configData);
