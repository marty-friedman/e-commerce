...
@UnitTest
public class UiStateHandlerTest extends AbstractProductConfigControllerBaseTest // inherit all the test helper methods for controller
{
	...
	public void testHandleProductConfigMessages_empty() throws Exception
	{
		...
		classUnderTest.handleProductConfigMessages(configData, model);
	...
	public void testExtractInstanceNameFromGroupId()
	{
		...
		assertEquals(INSTANCE_NAME, instanceName);
