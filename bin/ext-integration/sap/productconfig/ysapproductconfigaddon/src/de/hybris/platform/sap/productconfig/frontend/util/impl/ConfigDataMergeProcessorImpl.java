...
public class ConfigDataMergeProcessorImpl implements ConfigDataMergeProcessor
{
	 ...
	 */
	void updateTargetConfiguration(final ConfigurationData target, final Map<String, Object> sourceConfigMap)
	{
	 ...
	 * @param sourceConfigMap
	 */
	void updateGroupList(final List<UiGroupData> groups, final Map<String, Object> sourceConfigMap)
	{
		if (groups == null)
		{
			return;
