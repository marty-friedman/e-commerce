...
public class RuleConfigurableProductCustomerGroupsConditionTranslator implements RuleConditionTranslator
{
			...
			final List<String> customerGroups)
	{
		...
		irUserGroupCondition.setAttribute(RuleConfigurableProductCustomersConditionTranslator.USER_RAO_ID_ATTRIBUTE);
			...
			final List<String> customerGroups)
	{
		...
		for (final String customerGroup : customerGroups)
		{
			...
			irContainsUserGroupCondition.setAttribute(RuleConfigurableProductCustomersConditionTranslator.USER_RAO_ID_ATTRIBUTE);
