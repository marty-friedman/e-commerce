...
import de.hybris.platform.sap.productconfig.rules.action.strategy.impl.ProductConfigAbstarctRuleActionStrategy;
...
public class ConfigurationRulesTestData
{
			...
			final boolean visible)
	{
		...
		cstic.setConfigModelFactory(new ConfigModelFactoryImpl());
		cstic.setName(name);
		...
		value1.setConfigModelFactory(new ConfigModelFactoryImpl());
		final CsticValueModelImpl value2 = createCsticValue("VALUE_2");
		value2.setConfigModelFactory(new ConfigModelFactoryImpl());
		final CsticValueModelImpl value3 = createCsticValue("VALUE_3");
		value3.setConfigModelFactory(new ConfigModelFactoryImpl());
			...
			final boolean visible)
	{
		...
		value4.setConfigModelFactory(new ConfigModelFactoryImpl());
	...
	public static void initDependenciesOfActionStrategy(final ProductConfigAbstarctRuleActionStrategy classUnderTest)
	{
