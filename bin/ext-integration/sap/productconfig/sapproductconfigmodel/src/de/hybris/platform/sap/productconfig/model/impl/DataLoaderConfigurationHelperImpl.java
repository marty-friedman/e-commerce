...
public class DataLoaderConfigurationHelperImpl implements DataLoaderConfigurationHelper
{
	...
	public Map<String, String> createConfigMap(final DataloaderSourceParameters params)
	{
		...
		if (fieldsAvailable(configClazz))
		{
			...
			if (LOG.isDebugEnabled())
			{
				final StringBuilder sscDbFields = new StringBuilder("\n SSC DB properties are passed to ssc engine: ");
				sscDbFields.append("\n ").append(DataloaderConfiguration.DB_TYPE);
				sscDbFields.append("\n ").append(DataloaderConfiguration.DB_HOST);
				sscDbFields.append("\n ").append(DataloaderConfiguration.DB_NAME);
				sscDbFields.append("\n ").append(DataloaderConfiguration.DB_PORT);
				sscDbFields.append("\n ").append(DataloaderConfiguration.DB_USERNAME);
				sscDbFields.append("\n ").append(DataloaderConfiguration.DB_PASSWORD);
				sscDbFields.append("\n ").append(DB_JNDI_USAGE);
				sscDbFields.append("\n ").append(DB_JNDI_DATASOURCE);
				sscDbFields.append("\n ").append(DataloaderConfiguration.DB_CLIENT);
				LOG.debug(sscDbFields.toString());
			}
		}
