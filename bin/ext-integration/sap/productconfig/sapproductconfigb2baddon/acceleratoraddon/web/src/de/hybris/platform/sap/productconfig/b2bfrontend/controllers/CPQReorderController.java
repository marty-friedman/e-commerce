...
/**
 * CPQ Controller for Re-Order fuctionallity. In contrast to the hybris re-order controller 'ReorderCheckoutController'
 * this controller implements a special handling for configurable products to handle the case when the the knowledge
