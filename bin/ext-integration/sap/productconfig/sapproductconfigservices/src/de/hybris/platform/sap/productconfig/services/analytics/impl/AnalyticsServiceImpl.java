 ...
 */
public class AnalyticsServiceImpl implements de.hybris.platform.sap.productconfig.services.analytics.intf.AnalyticsService
{
	...
	{
		final AnalyticsDocument analyticData = getSessionAccessService().getAnalyticData(configId);
		...
		getSessionAccessService().setAnalyticData(configId, analyticsDocument);
