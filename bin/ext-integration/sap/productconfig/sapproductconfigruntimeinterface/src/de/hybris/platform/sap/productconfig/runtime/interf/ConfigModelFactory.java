...
public interface ConfigModelFactory
{
	...
	/**
	 * @deprecated This method used to return the class name of a now non-existing super type of
	 *             {@link CsticValueModelImpl}. Use {@link ConfigModelFactory#getTargetClassNameCsticValueModel()}
	 *             instead and call {@link CsticValueModel#setNumeric(boolean)}.
	 *
	 * @return class name of the {@link CsticValueModelImpl} implementation
	 */
	@Deprecated
	String getTargetClassNameCsticNumericValueModel();
