...
public class SapRevenueCloudProductInboudHelper
{
	...
	private final Logger LOG = LoggerFactory.getLogger(SapRevenueCloudProductInboudHelper.class);
	...
	public CatalogVersion processCatalogVersionForProduct(final String marketId) throws JaloInvalidParameterException
	{
	 ...
	 * @throws JaloInvalidParameterException
	 */
	public Product processProductForCodeAndMarketId(final String prodCodeMarkrtId) throws JaloInvalidParameterException
	{
	...
	public void processSubscriptionPricePlanEndDate(final String pricePlanId, final CatalogVersion cv)
	{
		...
		catch (final Exception e)
		{
			...
			{
				LOG.debug(format("Error while setting the end date for the price plan with ID %s.", pricePlanId) + e);
			}
	...
	public void createUpdatePayNowChargeEntry(final String pricePlanId, final CatalogVersion cv)
	{
		...
		catch (final Exception e)
		{
			...
			{
				LOG.debug(
						format("Error while creating and updating  One Time charge  for the price plan with ID %s.", pricePlanId) + e);
			}
