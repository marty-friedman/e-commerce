...
public class DefaultSapRevenueCloudProductServiceTest
{
	...
	public void throwExceptionIfPricePlanOrCatalogEmpty()
	{
		defaultSapRevenueCloudProductService.getSubscriptionPricePlanForId(null, null);

	}

	@Test(expected = ModelNotFoundException.class)
	public void throwExceptionIfNoSubscriptionPricePresent()
	{

		final CatalogVersionModel cv = new CatalogVersionModel();
		cv.setCatalog(new CatalogModel());
		when(sapRevenueCloudProductDao.getSubscriptionPricePlanForId(any(String.class), any(CatalogVersionModel.class)))
				.thenReturn(Optional.empty());
		defaultSapRevenueCloudProductService.getSubscriptionPricePlanForId("dummyPricePlan", cv);
