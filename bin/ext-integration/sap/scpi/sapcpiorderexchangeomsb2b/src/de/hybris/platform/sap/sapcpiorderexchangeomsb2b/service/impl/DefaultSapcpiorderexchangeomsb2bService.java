 ...
 */
package de.hybris.platform.sap.sapcpiorderexchangeomsb2b.service.impl;
...
public class DefaultSapcpiorderexchangeomsb2bService implements Sapcpiorderexchangeomsb2bService
{
	private static final Logger LOG = Logger.getLogger(DefaultSapcpiorderexchangeomsb2bService.class);
	...
	{
		return DefaultSapcpiorderexchangeomsb2bService.class
				.getResourceAsStream("/sapcpiorderexchangeomsb2b/sap-hybris-platform.png");
	}
