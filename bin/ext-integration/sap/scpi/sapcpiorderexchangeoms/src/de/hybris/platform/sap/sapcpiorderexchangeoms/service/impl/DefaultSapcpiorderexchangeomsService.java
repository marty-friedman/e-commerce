...
public class DefaultSapcpiorderexchangeomsService implements SapcpiorderexchangeomsService
{
	private static final Logger LOG = Logger.getLogger(DefaultSapcpiorderexchangeomsService.class);
	...
	{
		return DefaultSapcpiorderexchangeomsService.class.getResourceAsStream("/sapcpiorderexchangeoms/sap-hybris-platform.png");
	}
