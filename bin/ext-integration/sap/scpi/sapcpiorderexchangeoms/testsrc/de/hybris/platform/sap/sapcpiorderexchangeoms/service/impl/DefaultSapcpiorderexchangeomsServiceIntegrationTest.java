 ...
 */
@IntegrationTest
public class DefaultSapcpiorderexchangeomsServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "sapcpiorderexchangeomsPlatformLogo";

		// when
		final String logoUrl = sapcpiorderexchangeomsService.getHybrisLogoUrl(logoCode);
