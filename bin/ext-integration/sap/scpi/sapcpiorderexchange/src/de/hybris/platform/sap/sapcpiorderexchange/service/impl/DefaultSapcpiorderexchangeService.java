...
public class DefaultSapcpiorderexchangeService implements SapcpiorderexchangeService
{
	private static final Logger LOG = Logger.getLogger(DefaultSapcpiorderexchangeService.class);
	...
	{
		return DefaultSapcpiorderexchangeService.class.getResourceAsStream("/sapcpiorderexchange/sap-hybris-platform.png");
	}
