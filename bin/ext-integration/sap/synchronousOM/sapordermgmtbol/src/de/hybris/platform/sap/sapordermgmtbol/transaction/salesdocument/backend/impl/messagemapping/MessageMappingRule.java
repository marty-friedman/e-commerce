...
public class MessageMappingRule
{
	...
	public static class Pattern
	{
		 ...
		 */
		protected static final String agjustField(final String value)
		{
			...
			{
				if (value.trim().equals(ANY_PATTERN))
				{
					return null;
				}
				else
		 ...
		 * @return
		 */
		protected boolean isEqual(final Pattern o)
		{
			return equalsField(beClass, o.beClass) && equalsField(beNumber, o.beNumber) && equalsField(beSeverity, o.beSeverity);
		}
	...
	protected static final boolean equalsField(final Object a1, final Object a2)
	{
	 ...
	 */
	protected static final int hashCodeField(final Object obj)
	{
