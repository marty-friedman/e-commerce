...
public class DefaultScheduleLinePopulator implements Populator<Schedline, ScheduleLineData>
{
	...
	private void setFormatedScheduleLIne(final ScheduleLineData target, final String unitKey)
	{
		...
		{ convertBigDecimalToString(new BigDecimal(target.getConfirmedQuantity().doubleValue()), unitKey), target.getQuantityUnit(),
	...
	{
		return ConversionHelper.convertBigDecimalToString(BigDecimal.valueOf(input.doubleValue()));
	}
