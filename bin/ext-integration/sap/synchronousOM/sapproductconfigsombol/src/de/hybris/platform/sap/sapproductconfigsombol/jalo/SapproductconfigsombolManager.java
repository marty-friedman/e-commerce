...
public class SapproductconfigsombolManager extends GeneratedSapproductconfigsombolManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(SapproductconfigsombolManager.class);
	 ...
	 */
	public SapproductconfigsombolManager() // NOPMD 
	{
		LOG.debug("constructor of SapproductconfigsombolManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapproductconfigsombolManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapproductconfigsombolManager called, current tenant: {}", getTenant().getTenantID());
	}
