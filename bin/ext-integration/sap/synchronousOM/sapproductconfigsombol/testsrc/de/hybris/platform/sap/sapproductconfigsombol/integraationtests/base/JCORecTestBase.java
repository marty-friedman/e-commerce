...
public class JCORecTestBase extends SapproductconfigsombolBolSpringJunitTest
{
	 ...
	 * @return
	 */
	private File createFile(final URL repositoryResource, final File file)
	{
		File newfile = null;
		try
		{
			newfile = new File(repositoryResource.toURI());
		}
		catch (final URISyntaxException e)
		{
