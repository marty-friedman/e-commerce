...
public class SapproductconfigsomservicesManager extends GeneratedSapproductconfigsomservicesManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(SapproductconfigsomservicesManager.class);
	 ...
	 */
	public SapproductconfigsomservicesManager() // NOPMD 
	{
		LOG.debug("constructor of SapproductconfigsomservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapproductconfigsomservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapproductconfigsomservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
