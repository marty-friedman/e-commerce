...
public class DefaultAbstractOrderEntryConfigurationInfoPopulator implements Populator<ConfigModel, List<ConfigurationInfoData>>
{
	...
	public void addCsticForCartDisplay(final List<ConfigurationInfoData> configurationInfoInlineList,
	...
	{
		if (cstic.isVisible() && !CollectionUtils.isEmpty(cstic.getAssignedValues()))
		{
			return true;
		}
		return false;
