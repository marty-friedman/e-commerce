...
import de.hybris.platform.sap.sapordermgmtcfgfacades.constants.SapordermgmtcfgfacadesConstants;



/**
 * This is the extension manager of the Sapordermgmtcfgfacades extension.
 */
public class SapordermgmtcfgfacadesManager extends GeneratedSapordermgmtcfgfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapordermgmtcfgfacadesManager.class.getName());
	 ...
	 */
	public static SapordermgmtcfgfacadesManager getInstance()
	{
		return (SapordermgmtcfgfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapordermgmtcfgfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapordermgmtcfgfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapordermgmtcfgfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapordermgmtcfgfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapordermgmtcfgfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
