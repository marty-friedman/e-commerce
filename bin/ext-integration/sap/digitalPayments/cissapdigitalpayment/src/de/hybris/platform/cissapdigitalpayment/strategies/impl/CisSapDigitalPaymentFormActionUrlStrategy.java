...
public class CisSapDigitalPaymentFormActionUrlStrategy implements PaymentFormActionUrlStrategy
{
	...
	public String getHopRequestUrl()
	{
		...
		catch (final Exception e)
		{
			...
			{
				LOG.debug("Error while requesting for the card registration URL from SAP Digital payment" + e);
			}
			LOG.error("Error while requesting for the card registration URL from SAP Digital payment" + e.getStackTrace());
