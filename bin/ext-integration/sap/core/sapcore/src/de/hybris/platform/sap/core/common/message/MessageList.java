...
/**
 * Represents a List of <code>Message</code> objects. This class can be used to maintain a collection of such objects.
 * <br>
 ...
 */
@java.lang.SuppressWarnings("squid:S2250")
public class MessageList implements Iterable<Message>, Serializable
{


	private static final long serialVersionUID = -5212750411526039313L;
	/**
	 * List of messages.
	 */
	 ...
	 * <strong>If you try to add a message that is already present in the list, the item will be added
	 * again!</strong><br>
	 * 
	 * @param items
