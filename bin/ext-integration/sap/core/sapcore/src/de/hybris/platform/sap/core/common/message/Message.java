...
public class Message implements Serializable
{
	...
	private static final long serialVersionUID = -1945106167487567805L;
	...
	private transient ModuleResourceAccess moduleResourceAccess = null;
	...
	{
		return type == Message.INFO ? true : false;
	}
	...
	public int hashCode()
	{
		...
		synchronized (this)
		{
			if (hashCode == 0)
			{
				if (resourceKey == null || resourceKey.trim().length() == 0)
				{
					hashCode = (description == null ? 0 : description.hashCode()) ^ (property == null ? 0 : property.hashCode()) ^ type
							^ (refTechKey == null ? 0 : refTechKey.hashCode());
				}
				else
				{
					hashCode = resourceKey.hashCode() ^ (property == null ? 0 : property.hashCode()) ^ type
							^ (refTechKey == null ? 0 : refTechKey.hashCode());
	...
	public String toString()
	{
		...
		str.append(type).append(", ").append("Description: ").append(description).append(", ").append("Property: ").append(property)
				.append(", ").append("FieldId: ").append(fieldId).append(", ").append("ResourceKey: ").append(resourceKey)
				.append(", ");
