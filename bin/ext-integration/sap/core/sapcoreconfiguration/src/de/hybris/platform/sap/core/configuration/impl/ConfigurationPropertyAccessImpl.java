...
public class ConfigurationPropertyAccessImpl implements ConfigurationPropertyAccess
{
	...
	{
		// Ensure all values are loaded
		final String[] propertyAccessNames = propertyAccessMethods.keySet()
				.toArray(new String[propertyAccessMethods.keySet().size()]);
	...
	{
		// Ensure all values are loaded
		final String[] propertyAccessCollectionNames = propertyAccessCollectionMethods.keySet()
				.toArray(new String[propertyAccessCollectionMethods.keySet().size()]);
