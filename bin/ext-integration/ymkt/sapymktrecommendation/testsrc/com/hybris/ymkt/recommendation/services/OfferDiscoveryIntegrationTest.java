...
public class OfferDiscoveryIntegrationTest extends ServicelayerTransactionalTest
{
	...
	private static final boolean ISANONYMOUS = false;
	private static final String COMMUNICATION_MEDIUM = "ONLINE_SHOP";
	...
	public void setUp()
	{
		...
		INTERACTION01.setAnonymous(ISANONYMOUS);
		INTERACTION01.setCommunicationMedium(COMMUNICATION_MEDIUM);
		...
		INTERACTION01.setKey(KEY);
		INTERACTION01.setTimeStamp(DATE);
	...
	public void saveOfferInteractionTest()
	{
		...
		assertEquals(interaction.getTimeStamp(), model.getTimeStamp());
