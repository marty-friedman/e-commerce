...
public class RecommendationServiceFallbackTest {
	...
	final String RECOMMENDATION_TYPE = "P";
	boolean isFirstCacheCallTested = false;

	final List<String> LEADING_ITEMS_1 = new ArrayList<>(Arrays.asList("3", "2", "4", "1"));
	final List<String> LEADING_ITEMS_2 = new ArrayList<>(Arrays.asList("3", "1", "2"));
	final List<String> LEADING_ITEMS_3 = new ArrayList<>(Arrays.asList("4", "1"));
	final List<String> LEADING_ITEMS_4 = new ArrayList<>(Arrays.asList("1"));
	final List<String> LEADING_ITEMS_5 = new ArrayList<>(Arrays.asList(""));
	final List<String> LEADING_ITEMS_6 = new ArrayList<>(Arrays.asList("3"));
	final List<String> LEADING_ITEMS_7 = new ArrayList<>(Arrays.asList("10", "12", "23", "42", "11"));
	final List<String> LEADING_ITEMS_8 = new ArrayList<>(Arrays.asList("10", "12", "23", "3", "42", "11"));
	final List<String> LEADING_ITEMS_9 = new ArrayList<>(Arrays.asList("10", "15", "3", "2", "1"));
