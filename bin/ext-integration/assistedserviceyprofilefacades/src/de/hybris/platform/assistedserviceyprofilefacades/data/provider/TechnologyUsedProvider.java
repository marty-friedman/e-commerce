...
public class TechnologyUsedProvider implements FragmentModelProvider<SummaryTechnologyUsedData>
{
	...
	public SummaryTechnologyUsedData getModel(final Map<String, String> parameters)
	{
		...
		List<TechnologyUsedData> usedTechnologies = getyProfileAffinityFacade().getDeviceAffinities(deviceAffinityParameterData);

		Map<String, TechnologyUsedData> mostPopularTechnologyByDevice = new HashMap<>();
