...
public class ConsentLayerFilter extends OncePerRequestFilter
{
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (isProfileTrackingPaused(httpServletRequest, httpServletResponse)) {
    ...
    protected boolean isProfileTrackingPaused(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
        ...
        boolean profileTrackingConsentGiven = getConsentService().isProfileTrackingConsentGiven(httpServletRequest);
        getConsentService().setProfileConsentCookie(httpServletRequest, httpServletResponse, profileTrackingConsentGiven);

        return !profileTrackingConsentGiven || pauseProfileTrackingCookie.isPresent();
    }
