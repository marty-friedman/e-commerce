...
import com.hybris.yprofile.constants.YprofileeventadapterConstants;
...
/**
 * This is the extension manager of the Yprofileeventadapter extension.
 */
public class YprofileeventadapterManager extends GeneratedYprofileeventadapterManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YprofileeventadapterManager.class.getName());
	 ...
	 */
	public YprofileeventadapterManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YprofileeventadapterManager called.");
		}
	}
	 ...
	 */
	public static YprofileeventadapterManager getInstance()
	{
		return (YprofileeventadapterManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YprofileeventadapterConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YprofileeventadapterManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YprofileeventadapterManager called, current tenant: " + getTenant().getTenantID());
		}
	}
