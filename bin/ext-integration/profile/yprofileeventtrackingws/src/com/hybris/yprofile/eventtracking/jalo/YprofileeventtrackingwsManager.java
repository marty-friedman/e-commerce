 ...
 */
package com.hybris.yprofile.eventtracking.jalo;

import com.hybris.yprofile.eventtracking.constants.YprofileeventtrackingwsConstants;
...
/**
 * This is the extension manager of the Yprofileeventtrackingws extension.
 */
public class YprofileeventtrackingwsManager extends GeneratedYprofileeventtrackingwsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YprofileeventtrackingwsManager.class.getName());
	 ...
	 */
	public YprofileeventtrackingwsManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YprofileeventtrackingwsManager called.");
		}
	}
	 ...
	 */
	public static YprofileeventtrackingwsManager getInstance()
	{
		return (YprofileeventtrackingwsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YprofileeventtrackingwsConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YprofileeventtrackingwsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YprofileeventtrackingwsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
