...
public class GenerateProxies extends Task
{
	...
	protected List<File> collectTestSuiteFiles(final File projectDir)
	{
	...
	protected void generateJUnitProxy(final File packageDir, final File testSuiteFile) throws IOException
	{
		try
		{
		...
		{
			LOG.debug("Caught PyException", e);
			LOG.warn(String.format("Test suite file [%s] is malformed and will be ignored.", testSuiteFile.getName()));
		}
	}

	protected void generateJUnitTests(final String projectName, final List<File> testSuiteFiles) throws IOException
	{
	...
	protected File generateCleanTestSuiteFile(final File testSuiteFile) throws IOException
	{
	...
	protected RobotTestSuiteFactory getRobotTestSuiteFactory()
	{
		return testSuiteFactory;
	}

	protected TemplateProcessorFactory getTemplateProcessorFactory()
	{
		return templateProcessorFactory;
	}

	protected void processProjectDir(final String projectName, final File projectDir) throws IOException
	{
	...
	protected void processRobotDir(final File robotDir) throws IOException
	{
	...
	protected void prepareGeneratedDirectory() throws IOException
	{
	...
	protected void setRobotTestSuiteFactory(final RobotTestSuiteFactory robotTestSuiteFactory)
	{
