...
{
	private static volatile boolean initializedGlobals;
	...
	protected RobotTestResult createRobotTestResult(final PyObject errors)
	{
	...
	protected PyObject findTest(final RobotTest robotTest)
	{
	...
	protected static synchronized void setGlobalsInitialized() {
