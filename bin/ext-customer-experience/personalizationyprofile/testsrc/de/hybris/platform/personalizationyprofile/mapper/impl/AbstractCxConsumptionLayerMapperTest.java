...
import static de.hybris.platform.personalizationyprofile.mapper.impl.CxCategoryConsumptionLayerMapper.PREFIX;
import static de.hybris.platform.personalizationyprofile.mapper.impl.CxCategoryConsumptionLayerMapper.PREFIX_KEY;
...
public abstract class AbstractCxConsumptionLayerMapperTest
{
	...
	public void init()
	{
		...
		Mockito.when(configuration.getString(PREFIX_KEY, PREFIX)).thenReturn(PREFIX);
	}
