...
public class CalculatePersonalizationForUserActionIntegrationTest extends ServicelayerTest
{
	...
	@Test
	public void shouldNotStoreEmptyActionResultsOnUser() throws RetryLaterException, Exception
	{
		//given
		...
		processParameterHelper.setProcessParameter(process, PersonalizationservicesConstants.SESSION_TOKEN, defaultSessionTokenService.getOrCreateSessionToken());
		...
		assertNotResultStoredInDatabase();
	}

	protected void assertNotResultStoredInDatabase()
	{
		final List<CxResultsModel> resultsList = cxActionResultDao.findResultsBySessionKey(defaultSessionTokenService.getOrCreateSessionToken());
