...
public class DefaultCxActionResultServiceIntegrationTest extends ServicelayerTest
{
	...
	public void shouldSerializeDeserializeActionResults()
	{
		...
		final Optional<CxResultsModel> cxResultsOptional = cxActionResultDao.findResultsByKey(defaultCxActionResultService
				.getResultsKey(user, cv));
	...
	public void shouldNotLoadOlderResultsInSession()
	{
		...
		defaultCxActionResultService.storeActionResults(user, cv, results2);
		final Optional<CxResultsModel> storedResultsOptional = cxActionResultDao.findResultsByKey(defaultCxActionResultService
				.getResultsKey(user, cv));
