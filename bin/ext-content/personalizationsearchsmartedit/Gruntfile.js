...
module.exports = function(grunt) {
    ...
    grunt.registerTask('compile_only', ['sanitize', 'linting', 'copy:sources', 'multiNGTemplates', 'multiConcat', 'checkNoForbiddenNameSpaces', 'checkI18nKeysCompliancy', 'checkNoFocus', 'styling_only']);
