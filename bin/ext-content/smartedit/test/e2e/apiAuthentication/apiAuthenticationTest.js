...
describe("Authentication", function() {
    ...
    describe('After Login', function() {
        ...
        xit("WHEN the user is not authenticates to fake1 or fake2 API THEN fake 1 nor fake 2 are visible", function() {
    ...
    describe('Custom Iframe', function() {
        it("WHEN the user is logged in THEN the custom iframe successfully retrieves access token map", function() {
            ...
            login.loginAsCmsManager().then(function() {
                ...
                expect(element(by.id('tokens')).getText()).toBe("{\"/authorizationserver/oauth/token\":{\"access_token\":\"access-token0\",\"token_type\":\"bearer\"},\"custom_properties\":{\"previousUsername\":\"0645cf0d03f499a987480bb2d8485c8a3b657aab\"}}");
            });
        });
    });
});
