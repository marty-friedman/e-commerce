...
describe("languageSelector", function() {
    ...
    var leftToolbar = require('../utils/components/LeftToolbar.js');
    ...
    it("GIVEN I select French Language, AND submitting right credentials, THEN the store front should be localized with French",
        function() {
            ...
            leftToolbar.assertions.localiedFieldIsTranslated(by.id('localizationField'), 'Je suis localisée');
    ...
    it("GIVEN I logged in smartedit, AND change the language on the left toolbar, THEN the store front should be localized with French",
        function() {
            ...
            //THEN
            leftToolbar.actions.openLeftToolbar();
    ...
    it("GIVEN I selected French on the login page, AND I changed it to English on the leftToolbar, WHEN I logout THEN the login page should be localized in English",
        function() {
            ...
            selectLanguageAndLogin('French').then(function() {
                ...
                leftToolbar.actions.openLeftToolbar().then(function() {
    ...
    it("GIVEN I logged in smartedit, AND change the language on the left toolbar, THEN the decorators should be localized with French ",
        function() {
            ...
            perspectives.actions.selectPerspective(perspectives.constants.DEFAULT_PERSPECTIVES.ALL).then(function() {
                ...
                selectLanguage('French');
                leftToolbar.actions.closeLeftToolbar();
                browser.switchToIFrame();
