 ...
 */
angular.module('customViewModule', ['yjqueryModule', 'backendMocksModule', 'eventServiceModule', 'editorFieldMappingServiceModule', 'customReloadButtonModule'])
    ...
    .controller('customViewController', function(yjQuery, systemEventService) {
        ...
        this.setPOSTMode = function() {
            ...
            this.changeStructureEventListener = systemEventService.registerEventHandler('load-structure', this.onChangeStructureEvent.bind(this));
        };
