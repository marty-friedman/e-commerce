...
describe('Landing Page - ', function() {
    ...
    it('GIVEN I am on the landing page ' +
        ...
        function() {
            ...
            // THEN 
            landingPage.assertions.assertRightUrlIsLoaded(
                CONSTANTS.ACTION_FIGURES_SITE_ID, CONSTANTS.ACTION_FIGURES_CATALOG_ID, CONSTANTS.ACTIVE_CATALOG_VERSION);
        });
    ...
    it('GIVEN I am on the landing page ' +
        ...
        function() {
            ...
            // THEN 
            landingPage.assertions.assertRightUrlIsLoaded(
                CONSTANTS.TOYS_SITE_ID, CONSTANTS.TOYS_CATALOG_ID, CONSTANTS.ACTIVE_CATALOG_VERSION);
        });
});
