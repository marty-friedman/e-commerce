...
(function() {
    ...
    angular.module('e2eOnLoadingSetup', ['ngMockE2E', 'resourceLocationsModule'])
        ...
        .run(function(STOREFRONT_PATH, STOREFRONT_URI, $location, $timeout, $httpBackend, parseQuery) {
            ...
            $httpBackend.whenGET(/cmswebservices\/v1\/types\/PreviewData\?mode=DEFAULT/).respond({
                attributes: [{
