...
describe('renderService', function() {
    ...
    var crossFrameEventService, systemEventService, alertService, componentHandlerService, extractFromElement,
        ...
        previewService, sharedDataService;
    ...
    var MOCK_RESOURCE_PATH = "https://somedomain/storefronturl";
    ...
    beforeEach(module('sakExecutorDecorator', function($provide) {
        sakExecutor = jasmine.createSpyObj('sakExecutor', ['areAllDecoratorsProcessed', 'destroyAllScopes', 'destroyScope']);
    ...
    beforeEach(module('smarteditServicesModule', function($provide) {
        ...
        previewService = jasmine.createSpyObj('previewService', ['getResourcePathFromPreviewUrl', 'updateUrlWithNewPreviewTicketId']);
    ...
    beforeEach(module('renderServiceModule', function($provide) {
        ...
        systemEventService = jasmine.createSpyObj('systemEventService', ['sendSynchEvent', 'registerEventHandler']);
    ...
    describe('_cloneAndCompileComponent', function() {
        ...
        it('should create a shallow copy of the component and a SmartEdit decorator wrapper', function() {
            ...
            expect(document.createElement.calls.argsFor(1)[0]).toBe('div');
        });
    ...
    describe('renderPage', function() {
        ...
        it('call with isRerender:false will sendSynchEvent restartProcess', function() {
            renderService.renderPage(false);
            $rootScope.$digest();
            expect(systemEventService.sendSynchEvent).toHaveBeenCalledWith(CONTRACT_CHANGE_LISTENER_PROCESS_EVENTS.RESTART_PROCESS);
        });

        it('call with isRerender:true will sendSynchEvent restartProcess', function() {
