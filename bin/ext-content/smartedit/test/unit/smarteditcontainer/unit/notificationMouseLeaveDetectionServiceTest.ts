...
import {IBound} from 'smarteditcommons';
...
describe('notificationMouseLeaveDetectionService', () => {
	...
	beforeEach(() => {
		notificationMouseLeaveDetectionService = new NotificationMouseLeaveDetectionService(gatewayProxy, $document, $q);
	});
	...
	describe('initialization', () => {
		...
		it('intializes the gateway proxy with the proper identifier and list of methods', () => {
