...
import {IContextualMenuButton, IDecorator, IFeature, IToolbarItem} from 'smarteditcommons';
...
describe('outer featureService', () => {
	...
	beforeEach(() => {
		featureService = new FeatureService(gatewayProxy, toolbarServiceFactory, lodash, cloneableUtils, $q);
	});
