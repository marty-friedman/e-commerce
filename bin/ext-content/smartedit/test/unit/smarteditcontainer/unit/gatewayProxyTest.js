 ...
 */
describe('gatewayProxyModule', function() {

    var gatewayId = "toolbar";
    var $rootScope, $q, gatewayProxy, gatewayFactory, gateway;
    ...
    beforeEach(inject(function(_$rootScope_, _$q_, _gatewayProxy_) {
    ...
    it('gatewayProxy will wrap the result of non-empty functions in a promise', function() {
        ...
        gatewayProxy.initForService(service);
        var eventID = gateway.subscribe.calls.argsFor(0)[0];
        var onGatewayEvent = gateway.subscribe.calls.argsFor(0)[1];
