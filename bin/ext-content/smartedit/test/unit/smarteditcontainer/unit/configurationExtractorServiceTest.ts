...
describe('configurationExtractorService', () => {
	...
	describe('extractSEContainerModules', () => {
		...
		it('should add the administration module to applications and app locations', () => {
			expect(result.applications).toContain({name: 'administration', location: 'smarteditroot1/static-resources/smarteditcontainer/modules/administrationModule.js'});
		});
	...
	describe('extractSEModules', () => {
		...
		it('should add the administration module to applications and app locations', () => {
			expect(result.applications).toContain({name: 'systemModule', location: 'smarteditroot1/static-resources/smartedit/modules/systemModule.js'});
		});
