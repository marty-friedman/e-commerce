...
describe('seProductCatalogVersionsSelector controller', function() {
    ...
    beforeEach(function() {
        ...
        angular.module('catalogServiceModule', []);
    ...
    beforeEach(module('seProductCatalogVersionsSelectorModule', function($provide) {
        ...
        var systemEventService = jasmine.createSpyObj('systemEventService', ['registerEventHandler']);
