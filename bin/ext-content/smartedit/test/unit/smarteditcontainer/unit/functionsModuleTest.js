...
describe('functionsModule', function() {
    ...
    var escapeHtml, getDataFromResponse, getKeyHoldingDataFromResponse, isBlank, hitch, copy, customTimeout, merge, getQueryString, parseQuery, trim, convertToArray, uniqueArray, regExpFactory, generateIdentifier, closeOpenModalsOnBrowserBack, $uibModalStack, isAllTruthy, isAnyTruthy, compareHTMLElementsPosition, deepObjectPropertyDiff, deepIterateOverObjectWith;
    ...
    beforeEach(inject(function(_isBlank_, _hitch_, _copy_, _customTimeout_, _merge_, _getQueryString_,
        ...
        _deepObjectPropertyDiff_, _deepIterateOverObjectWith_) {
