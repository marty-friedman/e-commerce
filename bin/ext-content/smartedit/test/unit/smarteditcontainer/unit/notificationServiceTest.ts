...
describe('notificationService', () => {
	...
	const systemEventService: any = jasmine.createSpyObj('systemEventService', ['sendAsynchEvent']);
	...
	beforeEach(() => {
		systemEventService.sendAsynchEvent.and.returnValue(null);
		notificationService = new NotificationService(gatewayProxy, lodash, systemEventService, EVENT_NOTIFICATION_CHANGED, $q);
	});
