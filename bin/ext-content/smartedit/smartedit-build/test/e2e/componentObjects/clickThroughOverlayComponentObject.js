...
module.exports = function() {
    ...
    function ClickThroughOverlayComponentObject() {
        ...
        elements.allowClickThroughButton = function() {
            return browser.findElement(by.id('experienceSelectorToolbar_option_se.CLICK_THROUGH_OVERLAY_btn'));
        };
        elements.preventClickThroughButton = function() {
            return browser.findElement(by.id('experienceSelectorToolbar_option_se.PREVENT_OVERLAY_CLICKTHROUGH_btn'));
        };
