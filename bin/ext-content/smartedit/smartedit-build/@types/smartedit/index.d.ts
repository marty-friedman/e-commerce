...
export class ContextualMenuService {
    ...
    constructor($q: angular.IQService, priorityService: PriorityService, REFRESH_CONTEXTUAL_MENU_ITEMS_EVENT: string, uniqueArray: any, regExpFactory: any, systemEventService: any);
    /**
     * @ngdoc method
...
export class DragAndDropCrossOrigin {
    ...
    constructor($document: angular.IDocumentService, yjQuery: JQueryStatic, crossFrameEventService: any, inViewElementObserver: InViewElementObserver, _dragAndDropScrollingService: IDragAndDropScrollingService, SMARTEDIT_DRAG_AND_DROP_EVENTS: IDragAndDropEvents, SMARTEDIT_ELEMENT_HOVERED: string, polyfillService: PolyfillService);
    initialize(): void;
...
export class FeatureService extends IFeatureService {
    ...
    constructor(gatewayProxy: any, $log: angular.ILogService, decoratorService: any, lodash: lo.LoDashStatic, cloneableUtils: CloneableUtils, $q: angular.IQService, contextualMenuService: ContextualMenuService);
...
export const smarteditModule: string;
