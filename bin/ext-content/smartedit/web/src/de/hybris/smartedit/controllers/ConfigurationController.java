...
public class ConfigurationController
{
	...
	@ResponseBody
	public ResponseEntity<ConfigurationData> saveConfiguration(@RequestBody final Map<String, String> payload,
	...
	@ResponseBody
	public ResponseEntity<ConfigurationData> updateConfiguration(@RequestBody final Map<String, String> payload,
			@PathVariable("key") final String configId, final HttpServletRequest request) throws IOException
	{
	...
	@ResponseBody
	public ResponseEntity<Void> deleteConfiguration(@PathVariable("key") final String configId, final HttpServletRequest request)
			throws IOException
	{
