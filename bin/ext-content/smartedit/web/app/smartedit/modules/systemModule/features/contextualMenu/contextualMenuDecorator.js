...
angular.module('contextualMenuDecoratorModule', [
    ...
    .controller('contextualMenuController', function(
        ...
        this.onInit = function() {
            ...
            this.dndUnRegFn = systemEventService.registerEventHandler(CLOSE_CTX_MENU, this.hideAllPopups);
            this.unregisterRefreshItems = systemEventService.registerEventHandler(REFRESH_CONTEXTUAL_MENU_ITEMS_EVENT, this.updateItems);
