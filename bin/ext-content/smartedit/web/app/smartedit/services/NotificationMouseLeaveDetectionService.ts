...
export class NotificationMouseLeaveDetectionService extends INotificationMouseLeaveDetectionService {
	...
	constructor(gatewayProxy: any, private $document: any, private $q: angular.IQService) {
		super();
		gatewayProxy.initForService(this, ['stopDetection', '_remoteStartDetection', '_remoteStopDetection', '_callCallback'],
			'SE_NOTIFICATION_MOUSE_LEAVE_DETECTION_SERVICE_GATEWAY_ID');
