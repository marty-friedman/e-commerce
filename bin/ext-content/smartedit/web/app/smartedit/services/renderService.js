...
angular.module('renderServiceModule', [
    ...
    .service('renderService', function(
        ...
        this.renderSlots = function(_slotIds) {
            ...
            if (slotsRemaining.length <= 0) {
                ...
                return sharedDataService.get('experience').then(function(experience) {
                    ...
                    if (!experience) {
                        throw "renderslots - Invalid experience from sharedData";
                    }
                    ...
                    return previewService.getResourcePathFromPreviewUrl(experience.siteDescriptor.previewUrl).then(function(resourcePath) {
                        ...
                        return previewService.updateUrlWithNewPreviewTicketId($location.absUrl(), experience).then(function(storefrontUrl) {
                            ...
                            $log.error("renderService.renderSlots() - error with updateUrlWithNewPreviewTicketId");
                            return $q.reject(err);
                        });
                    }.bind(this), function(err) {
                        $log.error('renderService.renderSlots() - failed to retrieve resourcepath');
                        return $q.reject(err);
                    });
        ...
        systemEventService.registerEventHandler(CONTRACT_CHANGE_LISTENER_PROCESS_EVENTS.PROCESS_COMPONENTS, function(evtId, components) {
