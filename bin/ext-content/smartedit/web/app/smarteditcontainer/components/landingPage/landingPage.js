 ...
 *
 */
angular.module('landingPageModule', ['loadConfigModule', 'smarteditServicesModule', 'catalogServiceModule', 'permissionServiceModule', 'resourceLocationsModule', 'eventServiceModule', 'seDropdownModule'])
    ...
    .controller(
        ...
        function(loadConfigManagerService, siteService, catalogService, SITES_RESOURCE_URI, permissionService, selectedSiteCookieService, systemEventService, EVENTS, LINKED_DROPDOWN) {
            ...
            var unregisterSitesDropdownEvent = systemEventService.registerEventHandler(this.sites_id + LINKED_DROPDOWN, this.selectedSiteDropdownEvent.bind(this));
