...
angular.module('yNotificationPanelModule', [
     ...
     */
    .controller('YNotificationPanelController', function(notificationService, EVENT_NOTIFICATION_CHANGED, notificationMouseLeaveDetectionService, systemEventService, iFrameManager, $element, $window, $scope, $timeout) {
        ...
        var getIFrame = function() {
            return iFrameManager.getIframe()[0];
        };
        ...
        this.$onInit = function() {
            ...
            unRegisterNotificationChangedEventHandler = systemEventService.registerEventHandler(
