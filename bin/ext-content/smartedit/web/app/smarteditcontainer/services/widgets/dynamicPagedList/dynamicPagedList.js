...
(function() {
     ...
     *
     */
    angular.module('dynamicPagedListModule', ['pascalprecht.translate', 'ui.bootstrap', 'compileHtmlModule', 'seConstantsModule', 'ngSanitize', 'paginationFilterModule',
            'yDropDownMenuModule', 'yPaginationModule', 'smarteditServicesModule', 'yLoDashModule', 'yDataTableModule', 'iFrameManagerModule', 'hasOperationPermissionModule', 'filterByFieldFilterModule'
        ])
