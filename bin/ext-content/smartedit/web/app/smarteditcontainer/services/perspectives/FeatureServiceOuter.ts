...
import {CloneableUtils, InternalFeature, IFeatureService, IToolbarItem} from 'smarteditcommons';
...
export class FeatureService extends IFeatureService {
	...
	constructor(
		...
		this.features = [];
		gatewayProxy.initForService(this, ['_registerAliases', 'addToolbarItem', 'register',
