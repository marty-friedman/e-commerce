...
export class UrlService extends IUrlService {
	...
	constructor(private gatewayProxy: any, public $location: ng.ILocationService, public $window: ng.IWindowService, PAGE_CONTEXT_SITE_ID: string, PAGE_CONTEXT_CATALOG: string, PAGE_CONTEXT_CATALOG_VERSION: string, CONTEXT_SITE_ID: string, CONTEXT_CATALOG: string, CONTEXT_CATALOG_VERSION: string) {
