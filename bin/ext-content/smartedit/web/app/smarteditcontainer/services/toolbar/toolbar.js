 ...
 */
angular.module('toolbarModule', ['gatewayProxyModule', 'resourceLocationsModule', 'toolbarInterfaceModule', 'translationServiceModule', 'iframeClickDetectionServiceModule', 'eventServiceModule', 'toolbarItemContextModule'])
    /**
     * @ngdoc object
     ...
     */
    .directive('toolbar', function(toolbarServiceFactory, STORE_FRONT_CONTEXT, iframeClickDetectionService, CLOSE_ALL_ACTION_ITEMS, systemEventService, $location) {
        return {
            ...
            link: function(scope) {
                ...
                this.unregOverlay = systemEventService.registerEventHandler('OVERLAY_DISABLED', function() {
                    scope.$apply();
                });
