...
(function() {
     ...
     *
     */
    angular.module('dragAndDropServiceModule', ['yjqueryModule', 'yLoDashModule', '_dragAndDropScrollingModule', 'eventServiceModule', 'seConstantsModule', 'smarteditServicesModule'])
        ...
        .service('dragAndDropService', function($injector, $timeout, isBlank, yjQuery, lodash, _dragAndDropScrollingService, OVERLAY_COMPONENT_CLASS, inViewElementObserver, systemEventService, SMARTEDIT_DRAG_AND_DROP_EVENTS, dragAndDropCrossOrigin) {
            ...
            this._setDragAndDropExecutionStatus = function(isExecuting, element) {
                ...
                systemEventService.sendSynchEvent(isExecuting ? SMARTEDIT_DRAG_AND_DROP_EVENTS.DRAG_DROP_START : SMARTEDIT_DRAG_AND_DROP_EVENTS.DRAG_DROP_END, element);
            };
