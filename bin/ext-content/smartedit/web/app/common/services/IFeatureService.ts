...
import {CloneableUtils, InternalFeature, IContextualMenuButton, IDecorator, IFeature, IProxiedService, IToolbarItem} from 'smarteditcommons';
 ...
 */
export abstract class IFeatureService implements IProxiedService {
