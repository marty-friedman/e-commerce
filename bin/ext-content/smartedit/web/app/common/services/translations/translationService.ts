...
angular.module('translationServiceModule', ['pascalprecht.translate', 'i18nInterceptorModule', 'operationContextServiceModule'])
	...
	.config(function($translateProvider: any, I18NAPIROOT: string, UNDEFINED_LOCALE: string) {
		'ngInject';
        /*
	...
	.run(function(operationContextService: any, I18N_RESOURCE_URI: string, OPERATION_CONTEXT: any) {
		'ngInject';
