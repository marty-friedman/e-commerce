...
angular.module('yPopoverModule', [
    ...
    .controller('yPopoverController', function($log, $scope, $element, $sce, yjQuery, isBlank, $templateCache, yPopupEngineService, isIframe, OVERLAY_ID) {
        this.engine = null;
        this.config = null;
        ...
        this.$onInit = function() {
            var anchor = $element.children().first()[0];
            if (!$element.children().length) {
                $log.error('yPopover require child element for anchor.');
            }
