...
module.exports = function() {
    ...
    paths.target.featureExtensionsSmartEditImport = paths.target.features + '/personalizationpromotionssmartedit/index.ts';
    paths.target.featureExtensionsSmartEditContainerImport = paths.target.features + '/personalizationpromotionssmarteditContainer/index.ts';
