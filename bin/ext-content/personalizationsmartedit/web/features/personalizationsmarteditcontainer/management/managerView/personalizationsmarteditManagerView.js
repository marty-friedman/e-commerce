angular.module('personalizationsmarteditManagerViewModule', [
    ...
    .controller('personalizationsmarteditManagerViewController', function($q, $scope, $filter, confirmationModalService, personalizationsmarteditRestService, personalizationsmarteditMessageHandler, personalizationsmarteditContextService, personalizationsmarteditManager, systemEventService, personalizationsmarteditUtils, personalizationsmarteditDateUtils, personalizationsmarteditCommerceCustomizationView, personalizationsmarteditCommerceCustomizationService, PERSONALIZATION_VIEW_STATUS_MAPPING_CODES, PERSONALIZATION_MODEL_STATUS_CODES, PaginationHelper, waitDialogService) { //NOSONAR
        ...
        $scope.getCommerceCustomizationTooltip = personalizationsmarteditUtils.getCommerceCustomizationTooltipHTML;
        $scope.hasCommerceActions = personalizationsmarteditUtils.hasCommerceActions;
