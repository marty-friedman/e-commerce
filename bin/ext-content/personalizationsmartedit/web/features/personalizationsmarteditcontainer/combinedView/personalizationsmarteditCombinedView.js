angular.module('personalizationsmarteditCombinedViewModule', [
    ...
    .controller('personalizationsmarteditCombinedViewMenuController',
        function(
            ...
            $scope.isItemFromCurrentCatalog = personalizationsmarteditCombinedViewCommons.isItemFromCurrentCatalog;
    ...
    .controller('personalizationsmarteditCombinedViewController',
        function(
            ...
            $scope.getAndSetCatalogVersionNameL10N = personalizationsmarteditUtils.getAndSetCatalogVersionNameL10N;
        });
