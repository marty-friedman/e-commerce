 ...
 */
package de.hybris.platform.entitlementstorefront.jalo;
...
import de.hybris.platform.entitlementstorefront.constants.EntitlementstorefrontConstants;



/**
 * This is the extension manager of the Entitlementstorefront extension.
 */
public class EntitlementstorefrontManager extends GeneratedEntitlementstorefrontManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EntitlementstorefrontManager.class.getName());
	 ...
	 */
	public static EntitlementstorefrontManager getInstance()
	{
		return (EntitlementstorefrontManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EntitlementstorefrontConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EntitlementstorefrontManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EntitlementstorefrontManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EntitlementstorefrontManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EntitlementstorefrontManager called, current tenant: " + getTenant().getTenantID());
		}
	}
