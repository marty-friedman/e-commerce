...
public class B2BDocumentsSecureMediaFilter extends GenericFilterBean
{
	...
	protected void setSecureURLRendererForThread(final HttpServletResponse httpResponse)
	{
	...
	protected void sendData(final HttpServletResponse httpResponse, final InputStream mediaStream, final int length)
			throws IOException
	{
	...
	protected boolean isAccessGranted(final MediaModel mediaModel)
	{
	...
	protected boolean checkLoginUserB2BUnitHasAccessToMedia(final MediaModel mediaModel, final PK loginUserB2BUnitPK)
	{
