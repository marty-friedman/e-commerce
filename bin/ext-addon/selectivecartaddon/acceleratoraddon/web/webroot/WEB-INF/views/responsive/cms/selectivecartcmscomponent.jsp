	        	...
	        	<label class="cart-select-all-label">
	        		<c:choose>
		        	    <c:when test="${empty wishlistOrders}">
				       		<input type="checkbox" checked="checked" disabled="disabled" class="js-cart-select-all cart-select-checkbox" data-uncheckurl="${uncheckUrl}"/>
			        		<spring:theme code="wishlist2.action.selectall"/>
		        		</c:when>
		        		<c:otherwise>
		        			<input type="checkbox" disabled="disabled" class="js-cart-select-all cart-select-checkbox" data-checkurl="${checkUrl}"/>
			        		<spring:theme code="wishlist2.action.selectall"/>
		        		</c:otherwise>
	        		</c:choose>
	        	</label>
