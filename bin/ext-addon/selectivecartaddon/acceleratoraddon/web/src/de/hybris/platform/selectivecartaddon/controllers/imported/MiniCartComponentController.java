 ...
 */
package de.hybris.platform.selectivecartaddon.controllers.imported;
...
public class MiniCartComponentController extends AbstractCMSComponentController<MiniCartComponentModel>
{
	...
	protected String getView(final MiniCartComponentModel component) {
		...
		return SelectivecartaddonControllerConstants.Views.Cms.ComponentPrefix + StringUtils.lowerCase(getTypeCode(component));
	}
}
