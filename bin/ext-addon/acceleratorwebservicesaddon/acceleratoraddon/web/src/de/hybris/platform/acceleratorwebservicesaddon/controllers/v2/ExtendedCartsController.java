...
public class ExtendedCartsController
{
	...
	@ResponseBody
	@ApiOperation(value = "Get consolidated pickup options", notes = "Returns a list of stores that have all the pick-up items in stock.\n\nNote, if there are no stores "
	...
	@ResponseBody
	@ApiOperation(value = "Handles the consolidating pickup locations", notes = "Specifies one store location where all items will be picked up.\n\nNote, if any of the items are "
			+ "not available at the specified location, these items are removed from the cart.")
	@ApiBaseSiteIdUserIdAndCartIdParam
	public CartModificationListWsDTO consolidatePickupLocations(
	...
	@ApiOperation(value = "Get information needed for create subscription", notes = "Returns the necessary information for creating a subscription that contacts the "
	...
	@Secured(
	{ "ROLE_CUSTOMERGROUP", "ROLE_GUEST", "ROLE_CUSTOMERMANAGERGROUP", "ROLE_TRUSTED_CLIENT" })
	@ApiOperation(value = "Handles response from payment provider and create payment details", notes = "Handles the response from the payment provider and creates payment details."
	...
	@ApiBaseSiteIdUserIdAndCartIdParam
	public PaymentDetailsWsDTO handleSopPaymentResponse(@ApiIgnore final HttpServletRequest request,
	...
	@Secured(
	{ "ROLE_CUSTOMERGROUP", "ROLE_GUEST", "ROLE_CUSTOMERMANAGERGROUP", "ROLE_TRUSTED_CLIENT" })
	@ApiOperation(value = "Get information about create subscription request results", notes = "Returns information related to creating subscription request results. "
	...
	@Secured(
	{ "ROLE_CUSTOMERGROUP", "ROLE_GUEST", "ROLE_CUSTOMERMANAGERGROUP", "ROLE_TRUSTED_CLIENT" })
	@ApiOperation(value = "Deletes payment provider response related to cart", notes = "Deletes the payment provider response related to the specified cart.")
	@ApiBaseSiteIdUserIdAndCartIdParam
