 ...
 *
 */
public class ChineseProductSharingCellDecorator implements CSVCellDecorator
{
	...
	public String decorate(final int position, final Map<Integer, String> impexLine)
	{
		...
		final CatalogVersionModel catalogVersionModel = catalogVersionService.getCatalogVersion("electronicsContentCatalog","Staged");
