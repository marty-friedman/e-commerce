 ...
 *
 * @deprecated Deprecated since 6.7
 */
@Deprecated
public class SopResponseEventHandler extends AbstractRequestEventHandler
{
	 ...
	 */
	protected void persistPaymentMethod(final Map<String, String> resultParams)
	{
		validateParameterNotNullStandardMessage("Current customer", getCallContextController().getCurrentCustomer());
		...
		validateParameterNotNullStandardMessage("CardInfo", resultParams);
		validateParameterNotNullStandardMessage("Result parameter 'merchantPaymentMethodId'", resultParams.get("merchantPaymentMethodId"));
	...
	{
		validateParameterNotNullStandardMessage("Method param cardNumber", cardNumber);
