...
<%@ taglib prefix="account" tagdir="/WEB-INF/tags/addons/subscriptionstorefront/responsive/account"%>
	...
	<div class="tabs js-tabs tabs-responsive">
		<c:forEach items="${upsellingOptions}" var="upgradeOptionTab">
			...
			<div class="tabbody">
				...
				<spring:url value="/my-account/subscription/{/subscriptionDataId}" var="myAccountSubscriptionDetailsUrl" htmlEscape="false">
