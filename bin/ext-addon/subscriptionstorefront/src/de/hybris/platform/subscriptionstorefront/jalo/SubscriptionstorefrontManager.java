 ...
 */
package de.hybris.platform.subscriptionstorefront.jalo;
...
import de.hybris.platform.subscriptionstorefront.constants.SubscriptionstorefrontConstants;



/**
 * This is the extension manager of the Subscriptionstorefront extension.
 */
public class SubscriptionstorefrontManager extends GeneratedSubscriptionstorefrontManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SubscriptionstorefrontManager.class.getName());
	 ...
	 */
	public static SubscriptionstorefrontManager getInstance()
	{
		return (SubscriptionstorefrontManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SubscriptionstorefrontConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SubscriptionstorefrontManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SubscriptionstorefrontManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SubscriptionstorefrontManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SubscriptionstorefrontManager called, current tenant: " + getTenant().getTenantID());
		}
	}
