...
{
	public static final String MISSING_BOTH_PARAMS_MESSAGE = "At least one parameter is required.";
	...
	public static final String INVALID_VALUE_MESSAGE = "The value for parameter '%s' is invalid.";
