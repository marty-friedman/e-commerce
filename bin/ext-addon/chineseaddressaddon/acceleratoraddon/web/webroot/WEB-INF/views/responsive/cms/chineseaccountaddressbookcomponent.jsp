							...
							<c:choose>
								<c:when test="${fn:toUpperCase(currentLanguage.getIsocode()) eq 'ZH'}">
									<li>${fn:escapeXml(address.country.name)}&nbsp;
										<c:if test="${not empty fn:escapeXml(address.region.name)}">
											${fn:escapeXml(address.region.name)}
										</c:if></li>
									<li><c:if test="${not empty fn:escapeXml(address.city.name)}">
											${fn:escapeXml(address.city.name)}&nbsp;
										</c:if>
										<c:if test="${empty fn:escapeXml(address.city.name)}">
											${fn:escapeXml(address.town)}&nbsp;
										</c:if>
										<c:if test="${not empty fn:escapeXml(address.district.name)}">
								    ...
								    <c:if test="${not empty fn:escapeXml(address.cellphone)}">
								...
								<c:otherwise>
							        ...
							        <li><c:if test="${not empty fn:escapeXml(address.district.name)}">
											${fn:escapeXml(address.district.name)}&nbsp;
										</c:if>
										<c:if test="${not empty fn:escapeXml(address.city.name)}">
											${fn:escapeXml(address.city.name)}&nbsp;
										</c:if>
										<c:if test="${empty fn:escapeXml(address.city.name)}">
											${fn:escapeXml(address.town)}&nbsp;
										</c:if></li>
									<li><c:if test="${not empty fn:escapeXml(address.region.name)}">
											${fn:escapeXml(address.region.name)}&nbsp;
										</c:if>
		        		...
		        		<div class="addressItem">
							...
							<c:choose>
								<c:when test="${fn:toUpperCase(currentLanguage.getIsocode()) eq 'ZH'}">
									...
									<br><c:if test="${not empty fn:escapeXml(address.city.name)}">
											${fn:escapeXml(address.city.name)}&nbsp;
										</c:if>
										<c:if test="${empty fn:escapeXml(address.city.name)}">
											${fn:escapeXml(address.town)}&nbsp;
								...
								<c:otherwise>
							        ...
							        <br><c:if test="${not empty fn:escapeXml(address.district.name)}">
											${fn:escapeXml(address.district.name)}&nbsp;
										</c:if>
										<c:if test="${not empty fn:escapeXml(address.city.name)}">
											${fn:escapeXml(address.city.name)}&nbsp;
									...
									<br><c:if test="${not empty fn:escapeXml(address.region.name)}">
											${fn:escapeXml(address.region.name)}&nbsp;
										</c:if>
							        	${fn:escapeXml(address.country.name)}
							        <c:if test="${not empty fn:escapeXml(address.postalCode)}">
