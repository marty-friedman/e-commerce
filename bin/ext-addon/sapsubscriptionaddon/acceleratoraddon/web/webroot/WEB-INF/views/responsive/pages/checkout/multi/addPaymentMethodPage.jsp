...
<%@ taglib prefix="multi-checkout-addon" tagdir="/WEB-INF/tags/addons/sapsubscriptionaddon/responsive/checkout/multi"%>
...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
    ...
    <div class="row">
                    ...
                    <ycommerce:testId code="checkoutStepThree">
                        <div class="checkout-paymentmethod">
                            <div class="checkout-indent">
                                ...
                                <div class="headline"><spring:theme code="checkout.multi.paymentMethod"/>test</div>
        ...
        <div class="col-sm-6 hidden-xs">t
            <multi-checkout-addon:checkoutOrderDetails cartData="${cartData}" showDeliveryAddress="true" showPaymentInfo="false" showTaxEstimate="false" showTax="true" />
        </div>
