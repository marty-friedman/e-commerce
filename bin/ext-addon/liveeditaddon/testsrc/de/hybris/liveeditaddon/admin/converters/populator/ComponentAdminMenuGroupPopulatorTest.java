...
/**
 * Test suite for {@link de.hybris.liveeditaddon.admin.converters.populator.ComponentAdminMenuGroupPopulator}
 */
@UnitTest
public class ComponentAdminMenuGroupPopulatorTest
{
	...
	private ComponentAdminMenuGroupPopulator populator;
	...
	@Mock
	private Converter<ComponentActionMenuRequestData, ComponentAdminMenuItemData> menuItemConverter;

	@Before
	public void setUp()
	{
		MockitoAnnotations.initMocks(this);
		populator = new ComponentAdminMenuGroupPopulator();
	...
	public void testPopulate()
	{
		...
		given(menuItemConverter.convert(sourceActionMenuRequestData)).willReturn(convertedAdminMenuActionData);
		given(enumerationService.getEnumerationName(rootCMSComponentAdminActionGroup)).willReturn(ROOT_ACTION_GROUP_NAME);

		populator.populate(sourceActionMenuRequestData, targetAdminMenuGroupData);
