 ...
 */
package de.hybris.platform.customerticketingaddon.jalo;
...
/**
 * This is the extension manager of the Customerticketingaddon extension.
 */
public class CustomerticketingaddonManager extends GeneratedCustomerticketingaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CustomerticketingaddonManager.class.getName());
	 ...
	 */
	public static CustomerticketingaddonManager getInstance()
	{
		return (CustomerticketingaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CustomerticketingaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CustomerticketingaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CustomerticketingaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CustomerticketingaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CustomerticketingaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
