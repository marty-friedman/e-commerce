...
public class CustomerReviewController extends AbstractPageController
{
	...
	private static final String REVIEW_HEADLINE = "Review of Order No.";
			...
			final RedirectAttributes redirectAttrs) throws CMSItemNotFoundException
	{
		...
		orderReviewForm.getProductReviewForms().forEach(k -> {
			...
			reviewData.setHeadline(REVIEW_HEADLINE + orderCode);
			...
			throws CMSItemNotFoundException
	{
		...
		storeCmsPageInModel(model, getContentPageForLabelOrId("order"));
		setUpMetaDataForContentPage(model, getContentPageForLabelOrId("order"));
	}
