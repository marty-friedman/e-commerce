 ...
 */
package de.hybris.platform.b2cbtgaddon.jalo;

import de.hybris.platform.b2cbtgaddon.constants.B2cbtgaddonConstants;
...
/**
 * This is the extension manager of the B2cbtgaddon extension.
 */
public class B2cbtgaddonManager extends GeneratedB2cbtgaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2cbtgaddonManager.class.getName());
	 ...
	 */
	public static B2cbtgaddonManager getInstance()
	{
		return (B2cbtgaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(B2cbtgaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2cbtgaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2cbtgaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2cbtgaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2cbtgaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
