 ...
 */
package de.hybris.platform.chinaaccelerator.storefront.checkout.jalo;

import de.hybris.platform.chinaaccelerator.storefront.checkout.constants.ChinacheckoutaddonConstants;
...
/**
 * This is the extension manager of the Chinacheckoutaddon extension.
 */
public class ChinacheckoutaddonManager extends GeneratedChinacheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ChinacheckoutaddonManager.class.getName());
	 ...
	 */
	public static ChinacheckoutaddonManager getInstance()
	{
		return (ChinacheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ChinacheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinacheckoutaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinacheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinacheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinacheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
