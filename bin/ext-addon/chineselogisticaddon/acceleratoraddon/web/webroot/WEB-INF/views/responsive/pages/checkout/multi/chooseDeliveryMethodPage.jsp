...
<spring:url value="${nextStepUrl}" var="continueSelectDeliveryMethodUrl" htmlEscape="false"/>
<spring:url value="${previousStepUrl}" var="addDeliveryAddressUrl" htmlEscape="false"/>
