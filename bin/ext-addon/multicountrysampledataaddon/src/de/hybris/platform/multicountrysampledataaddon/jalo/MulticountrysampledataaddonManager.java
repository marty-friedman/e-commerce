 ...
 */
package de.hybris.platform.multicountrysampledataaddon.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.multicountrysampledataaddon.constants.MulticountrysampledataaddonConstants;
...
/**
 * This is the extension manager of the multicountrysampledataaddon extension.
 */
public class MulticountrysampledataaddonManager extends GeneratedMulticountrysampledataaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MulticountrysampledataaddonManager.class.getName());
	 ...
	 */
	public static MulticountrysampledataaddonManager getInstance()
	{
		return (MulticountrysampledataaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MulticountrysampledataaddonConstants.EXTENSIONNAME);
	}
	...
	public MulticountrysampledataaddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of multicountrysampledataaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of multicountrysampledataaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of multicountrysampledataaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
