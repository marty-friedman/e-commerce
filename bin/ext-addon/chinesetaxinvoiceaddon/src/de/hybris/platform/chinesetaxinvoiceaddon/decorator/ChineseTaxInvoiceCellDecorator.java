 ...
 *
 */
public class ChineseTaxInvoiceCellDecorator implements CSVCellDecorator
{
	private static final Logger LOG = Logger.getLogger(ChineseTaxInvoiceCellDecorator.class);
	...
	public String decorate(final int position, final Map<Integer, String> impexLine)
	{
		...
		{
			LOG.debug("Initialization:" + ChineseTaxInvoiceCellDecorator.class.getName() + " found components are "
