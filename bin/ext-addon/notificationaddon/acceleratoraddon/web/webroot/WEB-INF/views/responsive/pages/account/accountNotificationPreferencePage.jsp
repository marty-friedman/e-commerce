	...
	<div class="container-lg col-md-6">
		<div class="account-section-content">
			<div class="account-section-form">
				<form:form action="${fn:escapeXml(action)}" method="post" commandName="notificationPreferenceForm">	
					      ...
					      <c:if test="${preference.visible}">
								<div class="checkbox">
									<label class="control-label notification_preference_channel">
			   							...
			   							<input style="display:none" name= "channels[${status.index}].channel" value="${fn:escapeXml(preference.channel)}">
