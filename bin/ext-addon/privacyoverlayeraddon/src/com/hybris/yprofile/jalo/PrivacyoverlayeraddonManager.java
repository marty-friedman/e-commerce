...
import com.hybris.yprofile.constants.PrivacyoverlayeraddonConstants;



/**
 * This is the extension manager of the Privacyoverlayeraddon extension.
 */
public class PrivacyoverlayeraddonManager extends GeneratedPrivacyoverlayeraddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PrivacyoverlayeraddonManager.class.getName());
	 ...
	 */
	public static PrivacyoverlayeraddonManager getInstance()
	{
		return (PrivacyoverlayeraddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PrivacyoverlayeraddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PrivacyoverlayeraddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PrivacyoverlayeraddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PrivacyoverlayeraddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PrivacyoverlayeraddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
