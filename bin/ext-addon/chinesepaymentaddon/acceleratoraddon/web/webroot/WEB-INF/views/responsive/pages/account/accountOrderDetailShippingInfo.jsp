...
<spring:url value="/checkout/multi/summary/checkPaymentResult" var="checkPaymentResultUrl" htmlEscape="false"/>
	            ...
	            <c:if test="${not empty orderData.chinesePaymentInfo}">
	                <div class="col-sm-6 col-md-4 order-payment-data">
						...
						<div id="providerName" class="value-order">
	                    	${fn:escapeXml(orderData.chinesePaymentInfo.paymentProviderName)}&nbsp;<c:if test="${not empty orderData.chinesePaymentInfo.serviceType}">-&nbsp;${fn:escapeXml(orderData.chinesePaymentInfo.serviceType)}</c:if>
	                    </div>
	                 </div>
	                 <div class="col-sm-6 col-md-4 order-payment-data">
	                    <div class="label-order">
...
<div class="row pay-pop-container">
    <div class="payPop col-lg-4 col-sm-6 col-md-6 col-xs-12">
        ...
        <div class="payPopBtn clearfix">
        	<a href="${checkPaymentResultUrl}/${ycommerce:encodeUrl(orderData.code)}" class="btn btn-primary btn-block checkout-next"><spring:theme code="order.payment.successfully" /></a><br/>
            <a href="${checkPaymentResultUrl}/${ycommerce:encodeUrl(orderData.code)}" class="btn btn-primary btn-block checkout-next"><spring:theme code="order.payment.rencontre.problem" /></a>
            <br><br>
        </div>	
    </div>
</div>
