 ...
 */
package de.hybris.platform.b2bbtgaddon.btg;

import de.hybris.bootstrap.annotations.IntegrationTest;
import de.hybris.platform.b2bbtgaddon.model.btg.OrganizationOrdersReportingCronJobModel;
...
{ "classpath:/b2bbtgaddon-spring-test.xml" })
public class OrganizationOrdersReportingJobTest extends BaseCommerceBaseTest
{
	@Resource
	private OrganizationOrdersReportingJob organizationOrdersReportingTestJob;
	@Resource
	...
	private static final String jobBeanId = "organizationOrdersReportingTestJob";

	@Before
	public void setUp() throws Exception
	{
		if (flexibleSearchService
				.search("SELECT {" + ServicelayerJobModel.PK + "} FROM {" + ServicelayerJobModel._TYPECODE + "} WHERE " + "{"
		...
		importCsv("/b2bbtgaddon/test/testOrganizations.csv", "utf-8");
		importCsv("/b2bbtgaddon/test/testB2BCommerceCart.csv", "utf-8");
