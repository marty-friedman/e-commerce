 ...
 */
package de.hybris.platform.b2bbtgaddon.jalo;

import de.hybris.platform.b2bbtgaddon.constants.B2bbtgaddonConstants;
...
/**
 * This is the extension manager of the B2bbtgaddon extension.
 */
public class B2bbtgaddonManager extends GeneratedB2bbtgaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2bbtgaddonManager.class.getName());
	 ...
	 */
	public static B2bbtgaddonManager getInstance()
	{
		return (B2bbtgaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(B2bbtgaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2bbtgaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2bbtgaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2bbtgaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2bbtgaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
