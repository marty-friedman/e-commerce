...
import de.hybris.platform.timedaccesspromotionsstorefront.controllers.ControllerConstants;
...
public class ProductPageController extends AbstractPageController
{
			...
			UnsupportedEncodingException
	{
		...
		final List<String> productKeywords = productModel.getKeywords() == null ? null : productModel.getKeywords().stream().map(k -> k.getKeyword()).collect(Collectors.toList());
	...
	{
		final ProductModel productModel = productService.getProductForCode(decodeWithScheme(encodedProductCode, UTF_8));
