 ...
 */
package de.hybris.platform.generated.configurablebundles;
...
@IntegrationTest
public class Bundle_Cart_Tests extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setOutputDir(new File(Config.getParameter("atddengine.report-path"), "configurablebundles"));
			robotSettings.setLogName("Bundle_Cart_Tests-log");
			robotSettings.setOutputName("Bundle_Cart_Tests-output");
			robotSettings.setReportName("Bundle_Cart_Tests-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/srv/jenkins/workspace/configurablebundles-module_release-6.7.0/source/configurablebundleatddtests/genresources/robottests/Bundle_Cart_Tests.txt"));
		}
	...
	@Test
	public void Test_NewBundleAddsProductEntry()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_NewBundleAddsProductEntry";
	...
	@Test
	public void Test_ValidateBundle()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_ValidateBundle";
