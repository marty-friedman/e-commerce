	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20180308180212_commercesearch_artifact_develop_b38855a/prepare/build/source/commercesearchatddtests/genresources/robottests/GeneralSearch_Tests.txt"));
		}
