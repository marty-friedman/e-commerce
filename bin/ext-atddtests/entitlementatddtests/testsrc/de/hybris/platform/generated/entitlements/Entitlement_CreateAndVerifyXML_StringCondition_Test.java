	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/srv/jenkins/workspace/entitlements-module_release-6.7.0/source/entitlementatddtests/genresources/robottests/Entitlement_CreateAndVerifyXML_StringCondition_Test.txt"));
		}
