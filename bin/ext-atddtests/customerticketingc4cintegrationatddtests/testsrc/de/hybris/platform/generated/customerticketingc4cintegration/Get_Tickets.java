...
@IntegrationTest
public class Get_Tickets extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Get_Tickets-log");
			robotSettings.setOutputName("Get_Tickets-output");
			robotSettings.setReportName("Get_Tickets-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/srv/jenkins/workspace/customerticketingsystem-module_release-6.7.0/source/customerticketingc4cintegrationatddtests/genresources/robottests/Get_Tickets.txt"));
		}
	...
	@Test
	public void Test_Get_Tickets()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Get_Tickets";
	...
	@Test
	public void Test_Get_Tickets_VerifyTicketFieldValues()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Get_Tickets_VerifyTicketFieldValues";
