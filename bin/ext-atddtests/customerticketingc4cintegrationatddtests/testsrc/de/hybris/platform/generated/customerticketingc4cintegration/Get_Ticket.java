...
@IntegrationTest
public class Get_Ticket extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Get_Ticket-log");
			robotSettings.setOutputName("Get_Ticket-output");
			robotSettings.setReportName("Get_Ticket-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/srv/jenkins/workspace/customerticketingsystem-module_release-6.7.0/source/customerticketingc4cintegrationatddtests/genresources/robottests/Get_Ticket.txt"));
		}
	...
	@Test
	public void Test_Get_Ticket_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Get_Ticket_PASS";
	...
	@Test
	public void Test_Get_Ticket_VerifyTicketFieldValues()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Get_Ticket_VerifyTicketFieldValues";
