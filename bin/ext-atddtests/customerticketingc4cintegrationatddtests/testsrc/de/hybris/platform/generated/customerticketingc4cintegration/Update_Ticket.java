...
@IntegrationTest
public class Update_Ticket extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Update_Ticket-log");
			robotSettings.setOutputName("Update_Ticket-output");
			robotSettings.setReportName("Update_Ticket-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/srv/jenkins/workspace/customerticketingsystem-module_release-6.7.0/source/customerticketingc4cintegrationatddtests/genresources/robottests/Update_Ticket.txt"));
		}
	...
	@Test
	public void Test_Update_Ticket_Message_Empty_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Update_Ticket_Message_Empty_FAIL";
	...
	@Test
	public void Test_Update_Ticket_VerifyTicketFieldValues()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Update_Ticket_VerifyTicketFieldValues";
