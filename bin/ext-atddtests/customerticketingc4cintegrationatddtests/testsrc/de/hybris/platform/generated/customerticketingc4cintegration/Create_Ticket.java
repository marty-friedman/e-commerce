 ...
 */
package de.hybris.platform.generated.customerticketingc4cintegration;
...
@IntegrationTest
public class Create_Ticket extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setOutputDir(new File(Config.getParameter("atddengine.report-path"), "customerticketingc4cintegration"));
			robotSettings.setLogName("Create_Ticket-log");
			robotSettings.setOutputName("Create_Ticket-output");
			robotSettings.setReportName("Create_Ticket-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/srv/jenkins/workspace/customerticketingsystem-module_release-6.7.0/source/customerticketingc4cintegrationatddtests/genresources/robottests/Create_Ticket.txt"));
		}
	...
	{
		return "customerticketingc4cintegration";
	}
	...
	@Test
	public void Test_Create_Ticket_Subject_Empty_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Create_Ticket_Subject_Empty_FAIL";
	...
	@Test
	public void Test_Create_Ticket_Subject_256_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Create_Ticket_Subject_256_FAIL";
	...
	@Test
	public void Test_Create_Ticket_Message_Empty_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Create_Ticket_Message_Empty_FAIL";
	...
	@Test
	public void Test_Create_Ticket_Subject_255_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Create_Ticket_Subject_255_PASS";
	...
	@Test
	public void Test_Create_Ticket_MultipleTickets()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Create_Ticket_MultipleTickets";
	...
	@Test
	public void Test_Create_Ticket_VerifyTicketFieldValues()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Create_Ticket_VerifyTicketFieldValues";
