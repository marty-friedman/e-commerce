	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/srv/jenkins/workspace/entitlements-module_release-6.7.0/source/emsclientatddtests/genresources/robottests/Grant_Mapping_XML_Verification_SimpleCondition_Test.txt"));
		}
