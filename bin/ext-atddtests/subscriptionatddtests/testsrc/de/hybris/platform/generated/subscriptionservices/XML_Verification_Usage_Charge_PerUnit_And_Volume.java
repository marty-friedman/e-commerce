	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/srv/jenkins/workspace/subscriptions-module_release-6.7.0/source/subscriptionatddtests/genresources/robottests/XML_Verification_Usage_Charge_PerUnit_And_Volume.txt"));
		}
