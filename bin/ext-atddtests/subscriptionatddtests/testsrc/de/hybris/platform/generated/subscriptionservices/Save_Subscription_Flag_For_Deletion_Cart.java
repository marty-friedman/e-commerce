	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/srv/jenkins/workspace/subscriptions-module_release-6.7.0/source/subscriptionatddtests/genresources/robottests/Save_Subscription_Flag_For_Deletion_Cart.txt"));
		}
