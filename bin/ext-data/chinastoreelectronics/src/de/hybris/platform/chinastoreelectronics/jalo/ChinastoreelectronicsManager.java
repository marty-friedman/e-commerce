 ...
 */
package de.hybris.platform.chinastoreelectronics.jalo;
...
/**
 * This is the extension manager of the Chinastoreelectronics extension.
 */
public class ChinastoreelectronicsManager extends GeneratedChinastoreelectronicsManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(ChinastoreelectronicsManager.class.getName());
	 ...
	 */
	public static ChinastoreelectronicsManager getInstance()
	{
		return (ChinastoreelectronicsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ChinastoreelectronicsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinastoreelectronicsManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinastoreelectronicsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinastoreelectronicsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinastoreelectronicsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
