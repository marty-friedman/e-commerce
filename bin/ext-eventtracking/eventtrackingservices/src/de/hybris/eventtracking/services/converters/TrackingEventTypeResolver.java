...
public class TrackingEventTypeResolver implements TypeResolver<Map<String, Object>, AbstractTrackingEvent>
{
	...
	private Class<? extends AbstractTrackingEvent> getEcommerceEventType(Map<String, Object> trackingEventData, Map<String, Object> customVariablesPageScoped) throws IOException {
		/**
    ...
    private Map<String, CartItem> getCartItems(Map<String, Object> trackingEventData) throws IOException {
    ...
    private static String getProductSku(Map<String, Object> customVariablesPageScoped) {
    ...
    private Class<? extends AbstractTrackingEvent> getLinkEventType(Map<String, Object> trackingEventData) {
	...
	private Class<? extends AbstractTrackingEvent> getMiscEventTypes(Map<String, Object> trackingEventData) {
	...
	private Class<? extends AbstractTrackingEvent> getSiteSearchEventType(Map<String, Object> trackingEventData, Map<String, Object> customVariablesPageScoped) {
	...
	private Class<? extends AbstractTrackingEvent> getLogEventType(Map<String, Object> customVariablesPageScoped) {
        String productSku = getProductSku(customVariablesPageScoped);
