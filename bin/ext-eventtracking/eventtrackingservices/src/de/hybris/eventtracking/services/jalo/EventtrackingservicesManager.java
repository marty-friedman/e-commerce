 ...
 */
package de.hybris.eventtracking.services.jalo;

import de.hybris.eventtracking.services.constants.EventtrackingservicesConstants;
import de.hybris.eventtracking.services.jalo.GeneratedEventtrackingservicesManager;
...
/**
 * This is the extension manager of the Eventtrackingservices extension.
 */
public class EventtrackingservicesManager extends GeneratedEventtrackingservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EventtrackingservicesManager.class.getName());
	 ...
	 */
	public static EventtrackingservicesManager getInstance()
	{
		return (EventtrackingservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EventtrackingservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EventtrackingservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EventtrackingservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EventtrackingservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EventtrackingservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
