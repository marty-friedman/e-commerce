 ...
 */
package de.hybris.eventtracking.publisher.jalo;

import de.hybris.eventtracking.publisher.constants.EventtrackingpublisherConstants;
import de.hybris.eventtracking.publisher.jalo.GeneratedEventtrackingpublisherManager;
...
/**
 * This is the extension manager of the Eventtrackingpublisher extension.
 */
public class EventtrackingpublisherManager extends GeneratedEventtrackingpublisherManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EventtrackingpublisherManager.class.getName());
	 ...
	 */
	public static EventtrackingpublisherManager getInstance()
	{
		return (EventtrackingpublisherManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EventtrackingpublisherConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EventtrackingpublisherManager() // NOPMD 
	{
	...
	public void destroy()
	{
		...
		{
			LOG.debug("destroy() of EventtrackingpublisherManager called, current tenant: " + getTenant().getTenantID());
		}
	}
