 ...
 */
package de.hybris.eventtracking.model.jalo;

import de.hybris.eventtracking.model.constants.EventtrackingmodelConstants;
import de.hybris.eventtracking.model.jalo.GeneratedEventtrackingmodelManager;
...
/**
 * This is the extension manager of the Eventtrackingmodel extension.
 */
public class EventtrackingmodelManager extends GeneratedEventtrackingmodelManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EventtrackingmodelManager.class.getName());
	 ...
	 */
	public static EventtrackingmodelManager getInstance()
	{
		return (EventtrackingmodelManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EventtrackingmodelConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EventtrackingmodelManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EventtrackingmodelManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EventtrackingmodelManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EventtrackingmodelManager called, current tenant: " + getTenant().getTenantID());
		}
	}
