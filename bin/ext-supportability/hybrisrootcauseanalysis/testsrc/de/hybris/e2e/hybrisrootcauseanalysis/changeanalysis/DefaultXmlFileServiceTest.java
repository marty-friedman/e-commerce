...
public class DefaultXmlFileServiceTest extends ServicelayerTransactionalTest
{
	...
	public void setUp()
	{
		xmlFileService = Registry.getApplicationContext().getBean("defaultE2EXmlFileService", DefaultXmlFileService.class);
		mediaService = Registry.getApplicationContext().getBean("mediaService", DefaultMediaService.class);
