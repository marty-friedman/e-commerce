...
@IntegrationTest
public class TaxValueParserTest extends ServicelayerBaseTest
{
	@Resource
	TaxValueParser taxValueParser;
	...
	public void parseValues() throws ParserException
	{
		...
		//when
		final TaxOrDiscount parsedValue = taxValueParser.parseTaxOrDiscount(stringValue);
	...
	public void shouldFailOnNonExistingCurrency() throws ParserException
	{
		...
		//when
		taxValueParser.parseTaxOrDiscount(stringValue);
	}
